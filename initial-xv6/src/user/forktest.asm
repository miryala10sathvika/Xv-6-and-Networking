...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <getps+0xc>
  ...
  68:	41c50513          	addi	a0,a0,1052 # 480 <getps+0x1c>
  ...
  b8:	41c50513          	addi	a0,a0,1052 # 4d0 <getps+0x6c>
  ...
  d4:	3d050513          	addi	a0,a0,976 # 4a0 <getps+0x3c>
  ...
  ee:	3ce50513          	addi	a0,a0,974 # 4b8 <getps+0x54>
