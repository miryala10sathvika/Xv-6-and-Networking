...
main(int argc, char *argv[]) {
  ...
  6a:	7da50513          	addi	a0,a0,2010 # 840 <malloc+0xe8>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	4ae50513          	addi	a0,a0,1198 # 8b8 <digits>
 412:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	396c8c93          	addi	s9,s9,918 # 860 <malloc+0x108>
 ...
 4dc:	3e0b8b93          	addi	s7,s7,992 # 8b8 <digits>
 ...
 602:	25a98993          	addi	s3,s3,602 # 858 <malloc+0x100>
        while(*s != 0){
 606:	85ee                	mv	a1,s11
