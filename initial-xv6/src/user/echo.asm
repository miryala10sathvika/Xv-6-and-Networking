...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	4aa50513          	addi	a0,a0,1194 # 8c0 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	392c8c93          	addi	s9,s9,914 # 868 <malloc+0x104>
 ...
 4e8:	3dcb8b93          	addi	s7,s7,988 # 8c0 <digits>
 ...
 60e:	25698993          	addi	s3,s3,598 # 860 <malloc+0xfc>
        while(*s != 0){
 612:	85ee                	mv	a1,s11
