...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0c250513          	addi	a0,a0,194 # 6100 <malloc+0xe6>
      46:	00006097          	auipc	ra,0x6
      4a:	f1c080e7          	jalr	-228(ra) # 5f62 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	0a050513          	addi	a0,a0,160 # 6120 <malloc+0x106>
      88:	00006097          	auipc	ra,0x6
      8c:	eda080e7          	jalr	-294(ra) # 5f62 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	09050513          	addi	a0,a0,144 # 6138 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	09250513          	addi	a0,a0,146 # 6158 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	05a50513          	addi	a0,a0,90 # 6140 <malloc+0x126>
      ee:	00006097          	auipc	ra,0x6
      f2:	e74080e7          	jalr	-396(ra) # 5f62 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	06650513          	addi	a0,a0,102 # 6168 <malloc+0x14e>
     10a:	00006097          	auipc	ra,0x6
     10e:	e58080e7          	jalr	-424(ra) # 5f62 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	06450513          	addi	a0,a0,100 # 6190 <malloc+0x176>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	05050513          	addi	a0,a0,80 # 6190 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	04c58593          	addi	a1,a1,76 # 61a0 <malloc+0x186>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	02850513          	addi	a0,a0,40 # 6190 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	02c58593          	addi	a1,a1,44 # 61a8 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	ffc50513          	addi	a0,a0,-4 # 6190 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fe650513          	addi	a0,a0,-26 # 61b0 <malloc+0x196>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d90080e7          	jalr	-624(ra) # 5f62 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f5c50513          	addi	a0,a0,-164 # 61d8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f48a8a93          	addi	s5,s5,-184 # 61d8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ed650513          	addi	a0,a0,-298 # 61e8 <malloc+0x1ce>
     31a:	00006097          	auipc	ra,0x6
     31e:	c48080e7          	jalr	-952(ra) # 5f62 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	ed450513          	addi	a0,a0,-300 # 6208 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	c26080e7          	jalr	-986(ra) # 5f62 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ec250513          	addi	a0,a0,-318 # 6220 <malloc+0x206>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	eae98993          	addi	s3,s3,-338 # 6220 <malloc+0x206>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e6250513          	addi	a0,a0,-414 # 6220 <malloc+0x206>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	dd258593          	addi	a1,a1,-558 # 61a8 <malloc+0x18e>
    ...
    printf("write failed\n");
     ...
     3f0:	e5450513          	addi	a0,a0,-428 # 6240 <malloc+0x226>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b6e080e7          	jalr	-1170(ra) # 5f62 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e2250513          	addi	a0,a0,-478 # 6228 <malloc+0x20e>
     40e:	00006097          	auipc	ra,0x6
     412:	b54080e7          	jalr	-1196(ra) # 5f62 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	e0850513          	addi	a0,a0,-504 # 6228 <malloc+0x20e>
     428:	00006097          	auipc	ra,0x6
     42c:	b3a080e7          	jalr	-1222(ra) # 5f62 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	ddc50513          	addi	a0,a0,-548 # 6220 <malloc+0x206>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d00a0a13          	addi	s4,s4,-768 # 6250 <malloc+0x236>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c5c50513          	addi	a0,a0,-932 # 6258 <malloc+0x23e>
     604:	00006097          	auipc	ra,0x6
     608:	95e080e7          	jalr	-1698(ra) # 5f62 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c5650513          	addi	a0,a0,-938 # 6270 <malloc+0x256>
     622:	00006097          	auipc	ra,0x6
     626:	940080e7          	jalr	-1728(ra) # 5f62 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c6850513          	addi	a0,a0,-920 # 62a0 <malloc+0x286>
     640:	00006097          	auipc	ra,0x6
     644:	922080e7          	jalr	-1758(ra) # 5f62 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c7e50513          	addi	a0,a0,-898 # 62d0 <malloc+0x2b6>
     65a:	00006097          	auipc	ra,0x6
     65e:	908080e7          	jalr	-1784(ra) # 5f62 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c7050513          	addi	a0,a0,-912 # 62e0 <malloc+0x2c6>
     678:	00006097          	auipc	ra,0x6
     67c:	8ea080e7          	jalr	-1814(ra) # 5f62 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c62a0a13          	addi	s4,s4,-926 # 6310 <malloc+0x2f6>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	af2a8a93          	addi	s5,s5,-1294 # 61a8 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bbc50513          	addi	a0,a0,-1092 # 6318 <malloc+0x2fe>
     764:	00005097          	auipc	ra,0x5
     768:	7fe080e7          	jalr	2046(ra) # 5f62 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	bb650513          	addi	a0,a0,-1098 # 6330 <malloc+0x316>
     782:	00005097          	auipc	ra,0x5
     786:	7e0080e7          	jalr	2016(ra) # 5f62 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b3c50513          	addi	a0,a0,-1220 # 62d0 <malloc+0x2b6>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7c6080e7          	jalr	1990(ra) # 5f62 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	bb250513          	addi	a0,a0,-1102 # 6360 <malloc+0x346>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	7ac080e7          	jalr	1964(ra) # 5f62 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	bac50513          	addi	a0,a0,-1108 # 6378 <malloc+0x35e>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	78e080e7          	jalr	1934(ra) # 5f62 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	97e58593          	addi	a1,a1,-1666 # 61a0 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	95250513          	addi	a0,a0,-1710 # 6190 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	92650513          	addi	a0,a0,-1754 # 6190 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	91250513          	addi	a0,a0,-1774 # 6190 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b4c58593          	addi	a1,a1,-1204 # 6408 <malloc+0x3ee>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	89250513          	addi	a0,a0,-1902 # 6190 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a6650513          	addi	a0,a0,-1434 # 63a8 <malloc+0x38e>
     94a:	00005097          	auipc	ra,0x5
     94e:	618080e7          	jalr	1560(ra) # 5f62 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a6a50513          	addi	a0,a0,-1430 # 63c8 <malloc+0x3ae>
     966:	00005097          	auipc	ra,0x5
     96a:	5fc080e7          	jalr	1532(ra) # 5f62 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a6650513          	addi	a0,a0,-1434 # 63d8 <malloc+0x3be>
     97a:	00005097          	auipc	ra,0x5
     97e:	5e8080e7          	jalr	1512(ra) # 5f62 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a6a50513          	addi	a0,a0,-1430 # 63f8 <malloc+0x3de>
     996:	00005097          	auipc	ra,0x5
     99a:	5cc080e7          	jalr	1484(ra) # 5f62 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a3650513          	addi	a0,a0,-1482 # 63d8 <malloc+0x3be>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	5b8080e7          	jalr	1464(ra) # 5f62 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a5050513          	addi	a0,a0,-1456 # 6410 <malloc+0x3f6>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	59a080e7          	jalr	1434(ra) # 5f62 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a5250513          	addi	a0,a0,-1454 # 6430 <malloc+0x416>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	57c080e7          	jalr	1404(ra) # 5f62 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a3e50513          	addi	a0,a0,-1474 # 6450 <malloc+0x436>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a4e98993          	addi	s3,s3,-1458 # 6478 <malloc+0x45e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a7ea8a93          	addi	s5,s5,-1410 # 64b0 <malloc+0x496>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9d850513          	addi	a0,a0,-1576 # 6450 <malloc+0x436>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	99c50513          	addi	a0,a0,-1636 # 6450 <malloc+0x436>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	97a50513          	addi	a0,a0,-1670 # 6458 <malloc+0x43e>
     ae6:	00005097          	auipc	ra,0x5
     aea:	47c080e7          	jalr	1148(ra) # 5f62 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	98c50513          	addi	a0,a0,-1652 # 6488 <malloc+0x46e>
     b04:	00005097          	auipc	ra,0x5
     b08:	45e080e7          	jalr	1118(ra) # 5f62 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	9a650513          	addi	a0,a0,-1626 # 64c0 <malloc+0x4a6>
     b22:	00005097          	auipc	ra,0x5
     b26:	440080e7          	jalr	1088(ra) # 5f62 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9b250513          	addi	a0,a0,-1614 # 64e8 <malloc+0x4ce>
     b3e:	00005097          	auipc	ra,0x5
     b42:	424080e7          	jalr	1060(ra) # 5f62 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9b650513          	addi	a0,a0,-1610 # 6508 <malloc+0x4ee>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	408080e7          	jalr	1032(ra) # 5f62 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9b250513          	addi	a0,a0,-1614 # 6520 <malloc+0x506>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3ec080e7          	jalr	1004(ra) # 5f62 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9a050513          	addi	a0,a0,-1632 # 6540 <malloc+0x526>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	94e50513          	addi	a0,a0,-1714 # 6540 <malloc+0x526>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	90e50513          	addi	a0,a0,-1778 # 6548 <malloc+0x52e>
     c42:	00005097          	auipc	ra,0x5
     c46:	320080e7          	jalr	800(ra) # 5f62 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	91050513          	addi	a0,a0,-1776 # 6568 <malloc+0x54e>
     c60:	00005097          	auipc	ra,0x5
     c64:	302080e7          	jalr	770(ra) # 5f62 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	91c50513          	addi	a0,a0,-1764 # 6590 <malloc+0x576>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2e6080e7          	jalr	742(ra) # 5f62 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8a050513          	addi	a0,a0,-1888 # 6540 <malloc+0x526>
     ...
     cd0:	8e450513          	addi	a0,a0,-1820 # 65b0 <malloc+0x596>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	28e080e7          	jalr	654(ra) # 5f62 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8ee50513          	addi	a0,a0,-1810 # 65d8 <malloc+0x5be>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	270080e7          	jalr	624(ra) # 5f62 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8e850513          	addi	a0,a0,-1816 # 65f0 <malloc+0x5d6>
     d10:	00005097          	auipc	ra,0x5
     d14:	252080e7          	jalr	594(ra) # 5f62 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8f450513          	addi	a0,a0,-1804 # 6618 <malloc+0x5fe>
     d2c:	00005097          	auipc	ra,0x5
     d30:	236080e7          	jalr	566(ra) # 5f62 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8de50513          	addi	a0,a0,-1826 # 6630 <malloc+0x616>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8f658593          	addi	a1,a1,-1802 # 6660 <malloc+0x646>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8aa50513          	addi	a0,a0,-1878 # 6630 <malloc+0x616>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	89450513          	addi	a0,a0,-1900 # 6630 <malloc+0x616>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	87e50513          	addi	a0,a0,-1922 # 6630 <malloc+0x616>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8e258593          	addi	a1,a1,-1822 # 66a8 <malloc+0x68e>
  ...
  unlink("unlinkread");
     ...
     e32:	80250513          	addi	a0,a0,-2046 # 6630 <malloc+0x616>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7f250513          	addi	a0,a0,2034 # 6640 <malloc+0x626>
     e56:	00005097          	auipc	ra,0x5
     e5a:	10c080e7          	jalr	268(ra) # 5f62 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7fe50513          	addi	a0,a0,2046 # 6668 <malloc+0x64e>
     e72:	00005097          	auipc	ra,0x5
     e76:	0f0080e7          	jalr	240(ra) # 5f62 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	80250513          	addi	a0,a0,-2046 # 6688 <malloc+0x66e>
     e8e:	00005097          	auipc	ra,0x5
     e92:	0d4080e7          	jalr	212(ra) # 5f62 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	80e50513          	addi	a0,a0,-2034 # 66b0 <malloc+0x696>
     eaa:	00005097          	auipc	ra,0x5
     eae:	0b8080e7          	jalr	184(ra) # 5f62 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	81250513          	addi	a0,a0,-2030 # 66d0 <malloc+0x6b6>
     ec6:	00005097          	auipc	ra,0x5
     eca:	09c080e7          	jalr	156(ra) # 5f62 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	81650513          	addi	a0,a0,-2026 # 66f0 <malloc+0x6d6>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	080080e7          	jalr	128(ra) # 5f62 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	72258593          	addi	a1,a1,1826 # 6660 <malloc+0x646>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7ba58593          	addi	a1,a1,1978 # 6718 <malloc+0x6fe>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7aa50513          	addi	a0,a0,1962 # 6710 <malloc+0x6f6>
  ...
  unlink("lf1");
     ...
     f7e:	79650513          	addi	a0,a0,1942 # 6710 <malloc+0x6f6>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	78450513          	addi	a0,a0,1924 # 6710 <malloc+0x6f6>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	77650513          	addi	a0,a0,1910 # 6718 <malloc+0x6fe>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	73e58593          	addi	a1,a1,1854 # 6718 <malloc+0x6fe>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	72850513          	addi	a0,a0,1832 # 6718 <malloc+0x6fe>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	71058593          	addi	a1,a1,1808 # 6710 <malloc+0x6f6>
    1008:	00005517          	auipc	a0,0x5
    100c:	71050513          	addi	a0,a0,1808 # 6718 <malloc+0x6fe>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6f458593          	addi	a1,a1,1780 # 6710 <malloc+0x6f6>
    1024:	00005517          	auipc	a0,0x5
    1028:	7fc50513          	addi	a0,a0,2044 # 6820 <malloc+0x806>
    ...
    104a:	6da50513          	addi	a0,a0,1754 # 6720 <malloc+0x706>
    104e:	00005097          	auipc	ra,0x5
    1052:	f14080e7          	jalr	-236(ra) # 5f62 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6d650513          	addi	a0,a0,1750 # 6738 <malloc+0x71e>
    106a:	00005097          	auipc	ra,0x5
    106e:	ef8080e7          	jalr	-264(ra) # 5f62 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6d250513          	addi	a0,a0,1746 # 6750 <malloc+0x736>
    1086:	00005097          	auipc	ra,0x5
    108a:	edc080e7          	jalr	-292(ra) # 5f62 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6d650513          	addi	a0,a0,1750 # 6770 <malloc+0x756>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ec0080e7          	jalr	-320(ra) # 5f62 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6ea50513          	addi	a0,a0,1770 # 67a0 <malloc+0x786>
    10be:	00005097          	auipc	ra,0x5
    10c2:	ea4080e7          	jalr	-348(ra) # 5f62 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6e650513          	addi	a0,a0,1766 # 67b8 <malloc+0x79e>
    10da:	00005097          	auipc	ra,0x5
    10de:	e88080e7          	jalr	-376(ra) # 5f62 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6e250513          	addi	a0,a0,1762 # 67d0 <malloc+0x7b6>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e6c080e7          	jalr	-404(ra) # 5f62 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6ee50513          	addi	a0,a0,1774 # 67f8 <malloc+0x7de>
    1112:	00005097          	auipc	ra,0x5
    1116:	e50080e7          	jalr	-432(ra) # 5f62 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	70250513          	addi	a0,a0,1794 # 6828 <malloc+0x80e>
    112e:	00005097          	auipc	ra,0x5
    1132:	e34080e7          	jalr	-460(ra) # 5f62 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6f098993          	addi	s3,s3,1776 # 6848 <malloc+0x82e>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6c450513          	addi	a0,a0,1732 # 6858 <malloc+0x83e>
    119c:	00005097          	auipc	ra,0x5
    11a0:	dc6080e7          	jalr	-570(ra) # 5f62 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	67ea0a13          	addi	s4,s4,1662 # 6878 <malloc+0x85e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	62c50513          	addi	a0,a0,1580 # 6878 <malloc+0x85e>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5c450513          	addi	a0,a0,1476 # 6880 <malloc+0x866>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	c9e080e7          	jalr	-866(ra) # 5f62 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	5c450513          	addi	a0,a0,1476 # 68a0 <malloc+0x886>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c7e080e7          	jalr	-898(ra) # 5f62 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	5c850513          	addi	a0,a0,1480 # 68c0 <malloc+0x8a6>
    1300:	00005097          	auipc	ra,0x5
    1304:	c62080e7          	jalr	-926(ra) # 5f62 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	dd498993          	addi	s3,s3,-556 # 6138 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	72a78793          	addi	a5,a5,1834 # 7b18 <malloc+0x1afe>
  ...
  if(pid == 0){
    ...
    144e:	10e78793          	addi	a5,a5,270 # 8558 <malloc+0x253e>
    ...
    1472:	cca50513          	addi	a0,a0,-822 # 6138 <malloc+0x11e>
    ...
    148a:	4e250513          	addi	a0,a0,1250 # 6968 <malloc+0x94e>
    148e:	00005097          	auipc	ra,0x5
    1492:	ad4080e7          	jalr	-1324(ra) # 5f62 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	43a50513          	addi	a0,a0,1082 # 68e0 <malloc+0x8c6>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	ab4080e7          	jalr	-1356(ra) # 5f62 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	43a50513          	addi	a0,a0,1082 # 6900 <malloc+0x8e6>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a94080e7          	jalr	-1388(ra) # 5f62 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	43850513          	addi	a0,a0,1080 # 6920 <malloc+0x906>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a72080e7          	jalr	-1422(ra) # 5f62 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	44050513          	addi	a0,a0,1088 # 6948 <malloc+0x92e>
    1510:	00005097          	auipc	ra,0x5
    1514:	a52080e7          	jalr	-1454(ra) # 5f62 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	8a650513          	addi	a0,a0,-1882 # 6dc8 <malloc+0xdae>
    152a:	00005097          	auipc	ra,0x5
    152e:	a38080e7          	jalr	-1480(ra) # 5f62 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	42450513          	addi	a0,a0,1060 # 6990 <malloc+0x976>
    1574:	00005097          	auipc	ra,0x5
    1578:	9ee080e7          	jalr	-1554(ra) # 5f62 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	bf250513          	addi	a0,a0,-1038 # 6190 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    15cc:	bc8a0a13          	addi	s4,s4,-1080 # 6190 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	420a8a93          	addi	s5,s5,1056 # 69f0 <malloc+0x9d6>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	38050513          	addi	a0,a0,896 # 69c0 <malloc+0x9a6>
    1648:	00005097          	auipc	ra,0x5
    164c:	91a080e7          	jalr	-1766(ra) # 5f62 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	37c50513          	addi	a0,a0,892 # 69d8 <malloc+0x9be>
    1664:	00005097          	auipc	ra,0x5
    1668:	8fe080e7          	jalr	-1794(ra) # 5f62 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	38650513          	addi	a0,a0,902 # 6a00 <malloc+0x9e6>
    1682:	00005097          	auipc	ra,0x5
    1686:	8e0080e7          	jalr	-1824(ra) # 5f62 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	af8a0a13          	addi	s4,s4,-1288 # 6190 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	380a8a93          	addi	s5,s5,896 # 6a20 <malloc+0xa06>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	aa650513          	addi	a0,a0,-1370 # 6190 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    170c:	2d050513          	addi	a0,a0,720 # 69d8 <malloc+0x9be>
    1710:	00005097          	auipc	ra,0x5
    1714:	852080e7          	jalr	-1966(ra) # 5f62 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	30250513          	addi	a0,a0,770 # 6a28 <malloc+0xa0e>
    172e:	00005097          	auipc	ra,0x5
    1732:	834080e7          	jalr	-1996(ra) # 5f62 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9ea78793          	addi	a5,a5,-1558 # 6138 <malloc+0x11e>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2ee78793          	addi	a5,a5,750 # 6a48 <malloc+0xa2e>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2e650513          	addi	a0,a0,742 # 6a50 <malloc+0xa36>
  ...
  if(pid == 0) {
    ...
    179c:	2b850513          	addi	a0,a0,696 # 6a50 <malloc+0xa36>
    ...
    17b8:	2bc50513          	addi	a0,a0,700 # 6a70 <malloc+0xa56>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	7a6080e7          	jalr	1958(ra) # 5f62 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	1f050513          	addi	a0,a0,496 # 69c0 <malloc+0x9a6>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	78a080e7          	jalr	1930(ra) # 5f62 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	26c50513          	addi	a0,a0,620 # 6a58 <malloc+0xa3e>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	76e080e7          	jalr	1902(ra) # 5f62 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	92e50513          	addi	a0,a0,-1746 # 6138 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1842:	24250513          	addi	a0,a0,578 # 6a80 <malloc+0xa66>
    1846:	00004097          	auipc	ra,0x4
    184a:	71c080e7          	jalr	1820(ra) # 5f62 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	23e50513          	addi	a0,a0,574 # 6a98 <malloc+0xa7e>
    1862:	00004097          	auipc	ra,0x4
    1866:	700080e7          	jalr	1792(ra) # 5f62 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1e250513          	addi	a0,a0,482 # 6a50 <malloc+0xa36>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c7050513          	addi	a0,a0,-912 # 6508 <malloc+0x4ee>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	6c2080e7          	jalr	1730(ra) # 5f62 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	12450513          	addi	a0,a0,292 # 69d8 <malloc+0x9be>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	6a6080e7          	jalr	1702(ra) # 5f62 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	18250513          	addi	a0,a0,386 # 6a50 <malloc+0xa36>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1b850513          	addi	a0,a0,440 # 6ab0 <malloc+0xa96>
    1900:	00004097          	auipc	ra,0x4
    1904:	662080e7          	jalr	1634(ra) # 5f62 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	11050513          	addi	a0,a0,272 # 6ac8 <malloc+0xaae>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	5a2080e7          	jalr	1442(ra) # 5f62 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0a250513          	addi	a0,a0,162 # 6ae0 <malloc+0xac6>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	51c080e7          	jalr	1308(ra) # 5f62 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	09e50513          	addi	a0,a0,158 # 6af8 <malloc+0xade>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	500080e7          	jalr	1280(ra) # 5f62 <printf>
}
    ...
    1a90:	08450513          	addi	a0,a0,132 # 6b10 <malloc+0xaf6>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	4ce080e7          	jalr	1230(ra) # 5f62 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	06450513          	addi	a0,a0,100 # 6b30 <malloc+0xb16>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	48e080e7          	jalr	1166(ra) # 5f62 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e8250513          	addi	a0,a0,-382 # 69c0 <malloc+0x9a6>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	41c080e7          	jalr	1052(ra) # 5f62 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	fee50513          	addi	a0,a0,-18 # 6b48 <malloc+0xb2e>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	400080e7          	jalr	1024(ra) # 5f62 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	fea50513          	addi	a0,a0,-22 # 6b60 <malloc+0xb46>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	3e4080e7          	jalr	996(ra) # 5f62 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	dd250513          	addi	a0,a0,-558 # 69c0 <malloc+0x9a6>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	36c080e7          	jalr	876(ra) # 5f62 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	dae50513          	addi	a0,a0,-594 # 69c0 <malloc+0x9a6>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	348080e7          	jalr	840(ra) # 5f62 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	ef450513          	addi	a0,a0,-268 # 6b80 <malloc+0xb66>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	2ce080e7          	jalr	718(ra) # 5f62 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	eac50513          	addi	a0,a0,-340 # 6b90 <malloc+0xb76>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	276080e7          	jalr	630(ra) # 5f62 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	09650513          	addi	a0,a0,150 # 6dc8 <malloc+0xdae>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	228080e7          	jalr	552(ra) # 5f62 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	ff850513          	addi	a0,a0,-8 # 6dc8 <malloc+0xdae>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	18a080e7          	jalr	394(ra) # 5f62 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c5c50513          	addi	a0,a0,-932 # 6a58 <malloc+0xa3e>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	15e080e7          	jalr	350(ra) # 5f62 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d4250513          	addi	a0,a0,-702 # 6bb0 <malloc+0xb96>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0ec080e7          	jalr	236(ra) # 5f62 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	d2650513          	addi	a0,a0,-730 # 6bc8 <malloc+0xbae>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	0b8080e7          	jalr	184(ra) # 5f62 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	ce850513          	addi	a0,a0,-792 # 6bf0 <malloc+0xbd6>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	052080e7          	jalr	82(ra) # 5f62 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	20050513          	addi	a0,a0,512 # 61a8 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1c4a8a93          	addi	s5,s5,452 # 61a8 <malloc+0x18e>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c2cb8b93          	addi	s7,s7,-980 # 6c18 <malloc+0xbfe>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9c850513          	addi	a0,a0,-1592 # 69c0 <malloc+0x9a6>
    2000:	00004097          	auipc	ra,0x4
    2004:	f62080e7          	jalr	-158(ra) # 5f62 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b7e50513          	addi	a0,a0,-1154 # 6c38 <malloc+0xc1e>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	ea0080e7          	jalr	-352(ra) # 5f62 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	b0450513          	addi	a0,a0,-1276 # 6c20 <malloc+0xc06>
    2124:	00004097          	auipc	ra,0x4
    2128:	e3e080e7          	jalr	-450(ra) # 5f62 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	b2850513          	addi	a0,a0,-1240 # 6c60 <malloc+0xc46>
    2140:	00004097          	auipc	ra,0x4
    2144:	e22080e7          	jalr	-478(ra) # 5f62 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	b2450513          	addi	a0,a0,-1244 # 6c78 <malloc+0xc5e>
    215c:	00004097          	auipc	ra,0x4
    2160:	e06080e7          	jalr	-506(ra) # 5f62 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7ec50513          	addi	a0,a0,2028 # 69c0 <malloc+0x9a6>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d86080e7          	jalr	-634(ra) # 5f62 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	a9a50513          	addi	a0,a0,-1382 # 6c90 <malloc+0xc76>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d64080e7          	jalr	-668(ra) # 5f62 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	74850513          	addi	a0,a0,1864 # 69c0 <malloc+0x9a6>
    2280:	00004097          	auipc	ra,0x4
    2284:	ce2080e7          	jalr	-798(ra) # 5f62 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	a0c50513          	addi	a0,a0,-1524 # 6cb0 <malloc+0xc96>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	cb6080e7          	jalr	-842(ra) # 5f62 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9f450513          	addi	a0,a0,-1548 # 6cc8 <malloc+0xcae>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9c250513          	addi	a0,a0,-1598 # 6cc8 <malloc+0xcae>
  ...
  close(fd);
    ...
    2340:	99c70713          	addi	a4,a4,-1636 # 6cd8 <malloc+0xcbe>
    ...
    2394:	a2850513          	addi	a0,a0,-1496 # 6db8 <malloc+0xd9e>
    2398:	00004097          	auipc	ra,0x4
    239c:	bca080e7          	jalr	-1078(ra) # 5f62 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	a2450513          	addi	a0,a0,-1500 # 6dd8 <malloc+0xdbe>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	ba6080e7          	jalr	-1114(ra) # 5f62 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9e650513          	addi	a0,a0,-1562 # 6df8 <malloc+0xdde>
    241a:	00004097          	auipc	ra,0x4
    241e:	b48080e7          	jalr	-1208(ra) # 5f62 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	59250513          	addi	a0,a0,1426 # 69c0 <malloc+0x9a6>
    2436:	00004097          	auipc	ra,0x4
    243a:	b2c080e7          	jalr	-1236(ra) # 5f62 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	52450513          	addi	a0,a0,1316 # 69c0 <malloc+0x9a6>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	abe080e7          	jalr	-1346(ra) # 5f62 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8b050513          	addi	a0,a0,-1872 # 6dc8 <malloc+0xdae>
    2520:	00004097          	auipc	ra,0x4
    2524:	a42080e7          	jalr	-1470(ra) # 5f62 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	85850513          	addi	a0,a0,-1960 # 6e20 <malloc+0xe06>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	992080e7          	jalr	-1646(ra) # 5f62 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	c2050513          	addi	a0,a0,-992 # 6208 <malloc+0x1ee>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	972080e7          	jalr	-1678(ra) # 5f62 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	49878793          	addi	a5,a5,1176 # 7b18 <malloc+0x1afe>
  ...
  if(ret != -1){
    ...
    26c6:	77650513          	addi	a0,a0,1910 # 6e38 <malloc+0xe1e>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	898080e7          	jalr	-1896(ra) # 5f62 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	20050513          	addi	a0,a0,512 # 68e0 <malloc+0x8c6>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	87a080e7          	jalr	-1926(ra) # 5f62 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	20250513          	addi	a0,a0,514 # 6900 <malloc+0x8e6>
    2706:	00004097          	auipc	ra,0x4
    270a:	85c080e7          	jalr	-1956(ra) # 5f62 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	20250513          	addi	a0,a0,514 # 6920 <malloc+0x906>
    2726:	00004097          	auipc	ra,0x4
    272a:	83c080e7          	jalr	-1988(ra) # 5f62 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	20c50513          	addi	a0,a0,524 # 6948 <malloc+0x92e>
    2744:	00004097          	auipc	ra,0x4
    2748:	81e080e7          	jalr	-2018(ra) # 5f62 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6f050513          	addi	a0,a0,1776 # 6e78 <malloc+0xe5e>
  ...
  if(n >= 0){
    ...
    27bc:	6e050513          	addi	a0,a0,1760 # 6e98 <malloc+0xe7e>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	7a2080e7          	jalr	1954(ra) # 5f62 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	66e50513          	addi	a0,a0,1646 # 6e40 <malloc+0xe26>
    27da:	00003097          	auipc	ra,0x3
    27de:	788080e7          	jalr	1928(ra) # 5f62 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	66c50513          	addi	a0,a0,1644 # 6e58 <malloc+0xe3e>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	76e080e7          	jalr	1902(ra) # 5f62 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	67a50513          	addi	a0,a0,1658 # 6e80 <malloc+0xe66>
    280e:	00003097          	auipc	ra,0x3
    2812:	754080e7          	jalr	1876(ra) # 5f62 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	64e50513          	addi	a0,a0,1614 # 6e78 <malloc+0xe5e>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	ad450513          	addi	a0,a0,-1324 # 6310 <malloc+0x2f6>
  ...
  if(n >= 0){
    ...
    286a:	66250513          	addi	a0,a0,1634 # 6ec8 <malloc+0xeae>
    286e:	00003097          	auipc	ra,0x3
    2872:	6f4080e7          	jalr	1780(ra) # 5f62 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	60050513          	addi	a0,a0,1536 # 6e80 <malloc+0xe66>
    2888:	00003097          	auipc	ra,0x3
    288c:	6da080e7          	jalr	1754(ra) # 5f62 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	5f050513          	addi	a0,a0,1520 # 6ef0 <malloc+0xed6>
    2908:	00003097          	auipc	ra,0x3
    290c:	65a080e7          	jalr	1626(ra) # 5f62 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5be50513          	addi	a0,a0,1470 # 6f10 <malloc+0xef6>
    295a:	00003097          	auipc	ra,0x3
    295e:	608080e7          	jalr	1544(ra) # 5f62 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	5ba50513          	addi	a0,a0,1466 # 6f70 <malloc+0xf56>
    29be:	00003097          	auipc	ra,0x3
    29c2:	5a4080e7          	jalr	1444(ra) # 5f62 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	55850513          	addi	a0,a0,1368 # 6f30 <malloc+0xf16>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	582080e7          	jalr	1410(ra) # 5f62 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	55c50513          	addi	a0,a0,1372 # 6f50 <malloc+0xf36>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	566080e7          	jalr	1382(ra) # 5f62 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	45250513          	addi	a0,a0,1106 # 6f90 <malloc+0xf76>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	41c080e7          	jalr	1052(ra) # 5f62 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	47e50513          	addi	a0,a0,1150 # 6fd8 <malloc+0xfbe>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	400080e7          	jalr	1024(ra) # 5f62 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	47e50513          	addi	a0,a0,1150 # 6ff8 <malloc+0xfde>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	3e0080e7          	jalr	992(ra) # 5f62 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	49e50513          	addi	a0,a0,1182 # 7038 <malloc+0x101e>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	3c0080e7          	jalr	960(ra) # 5f62 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	4b250513          	addi	a0,a0,1202 # 7068 <malloc+0x104e>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	3a4080e7          	jalr	932(ra) # 5f62 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	4ca50513          	addi	a0,a0,1226 # 70a0 <malloc+0x1086>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	384080e7          	jalr	900(ra) # 5f62 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4b850513          	addi	a0,a0,1208 # 70c8 <malloc+0x10ae>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4a650513          	addi	a0,a0,1190 # 70c8 <malloc+0x10ae>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	45a50513          	addi	a0,a0,1114 # 70d0 <malloc+0x10b6>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2e4080e7          	jalr	740(ra) # 5f62 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	45650513          	addi	a0,a0,1110 # 70e8 <malloc+0x10ce>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	2c8080e7          	jalr	712(ra) # 5f62 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	e1a50513          	addi	a0,a0,-486 # 6ac8 <malloc+0xaae>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	2ac080e7          	jalr	684(ra) # 5f62 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	42850513          	addi	a0,a0,1064 # 7100 <malloc+0x10e6>
  ...
  close(fd);
    ...
    2d24:	cb850513          	addi	a0,a0,-840 # 69d8 <malloc+0x9be>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	23a080e7          	jalr	570(ra) # 5f62 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	05a50513          	addi	a0,a0,90 # 6dc8 <malloc+0xdae>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1ec080e7          	jalr	492(ra) # 5f62 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	00450513          	addi	a0,a0,4 # 6dc8 <malloc+0xdae>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	196080e7          	jalr	406(ra) # 5f62 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	fa450513          	addi	a0,a0,-92 # 6dc8 <malloc+0xdae>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	136080e7          	jalr	310(ra) # 5f62 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e3050513          	addi	a0,a0,-464 # 6dc8 <malloc+0xdae>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	fc2080e7          	jalr	-62(ra) # 5f62 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	14c50513          	addi	a0,a0,332 # 6138 <malloc+0x11e>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1b078793          	addi	a5,a5,432 # 61a8 <malloc+0x18e>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2ae50513          	addi	a0,a0,686 # 72d8 <malloc+0x12be>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0f450513          	addi	a0,a0,244 # 7130 <malloc+0x1116>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	13650513          	addi	a0,a0,310 # 7188 <malloc+0x116e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	19050513          	addi	a0,a0,400 # 7200 <malloc+0x11e6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1e450513          	addi	a0,a0,484 # 7270 <malloc+0x1256>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	22a50513          	addi	a0,a0,554 # 72c8 <malloc+0x12ae>
  ...
  unlink("12345678901234");
    ...
    3120:	fec50513          	addi	a0,a0,-20 # 7108 <malloc+0x10ee>
    3124:	00003097          	auipc	ra,0x3
    3128:	e3e080e7          	jalr	-450(ra) # 5f62 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	01850513          	addi	a0,a0,24 # 7150 <malloc+0x1136>
    3140:	00003097          	auipc	ra,0x3
    3144:	e22080e7          	jalr	-478(ra) # 5f62 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	06450513          	addi	a0,a0,100 # 71b8 <malloc+0x119e>
    315c:	00003097          	auipc	ra,0x3
    3160:	e06080e7          	jalr	-506(ra) # 5f62 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	0c050513          	addi	a0,a0,192 # 7230 <malloc+0x1216>
    3178:	00003097          	auipc	ra,0x3
    317c:	dea080e7          	jalr	-534(ra) # 5f62 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	10450513          	addi	a0,a0,260 # 7290 <malloc+0x1276>
    3194:	00003097          	auipc	ra,0x3
    3198:	dce080e7          	jalr	-562(ra) # 5f62 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	14050513          	addi	a0,a0,320 # 72e8 <malloc+0x12ce>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	db2080e7          	jalr	-590(ra) # 5f62 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	12c50513          	addi	a0,a0,300 # 7320 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	11250513          	addi	a0,a0,274 # 7330 <malloc+0x1316>
    3226:	00003097          	auipc	ra,0x3
    322a:	d3c080e7          	jalr	-708(ra) # 5f62 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	07250513          	addi	a0,a0,114 # 7320 <malloc+0x1306>
  ...
  unlink("diskfulldir");
    ...
    32c6:	05e50513          	addi	a0,a0,94 # 7320 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f6050513          	addi	a0,a0,-160 # 7350 <malloc+0x1336>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b6a080e7          	jalr	-1174(ra) # 5f62 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f7250513          	addi	a0,a0,-142 # 7380 <malloc+0x1366>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f5e50513          	addi	a0,a0,-162 # 7380 <malloc+0x1366>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f8a50513          	addi	a0,a0,-118 # 73c0 <malloc+0x13a6>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fa650513          	addi	a0,a0,-90 # 73f0 <malloc+0x13d6>
    ...
    346e:	f1e50513          	addi	a0,a0,-226 # 7388 <malloc+0x136e>
    3472:	00003097          	auipc	ra,0x3
    3476:	af0080e7          	jalr	-1296(ra) # 5f62 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	f1a50513          	addi	a0,a0,-230 # 73a0 <malloc+0x1386>
    348e:	00003097          	auipc	ra,0x3
    3492:	ad4080e7          	jalr	-1324(ra) # 5f62 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	f2e50513          	addi	a0,a0,-210 # 73d0 <malloc+0x13b6>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	ab8080e7          	jalr	-1352(ra) # 5f62 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	f3a50513          	addi	a0,a0,-198 # 73f8 <malloc+0x13de>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a9c080e7          	jalr	-1380(ra) # 5f62 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e8e50513          	addi	a0,a0,-370 # 7380 <malloc+0x1366>
    ...
    350a:	e7a50513          	addi	a0,a0,-390 # 7380 <malloc+0x1366>
    ...
    351e:	ea650513          	addi	a0,a0,-346 # 73c0 <malloc+0x13a6>
    ...
    353e:	48650513          	addi	a0,a0,1158 # 69c0 <malloc+0x9a6>
    3542:	00003097          	auipc	ra,0x3
    3546:	a20080e7          	jalr	-1504(ra) # 5f62 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e3250513          	addi	a0,a0,-462 # 7388 <malloc+0x136e>
    355e:	00003097          	auipc	ra,0x3
    3562:	a04080e7          	jalr	-1532(ra) # 5f62 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e9e50513          	addi	a0,a0,-354 # 7410 <malloc+0x13f6>
    357a:	00003097          	auipc	ra,0x3
    357e:	9e8080e7          	jalr	-1560(ra) # 5f62 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e4250513          	addi	a0,a0,-446 # 73d0 <malloc+0x13b6>
    3596:	00003097          	auipc	ra,0x3
    359a:	9cc080e7          	jalr	-1588(ra) # 5f62 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e5c50513          	addi	a0,a0,-420 # 7428 <malloc+0x140e>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e4850513          	addi	a0,a0,-440 # 7428 <malloc+0x140e>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e5450513          	addi	a0,a0,-428 # 7448 <malloc+0x142e>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e2050513          	addi	a0,a0,-480 # 7428 <malloc+0x140e>
    ...
    362c:	d6050513          	addi	a0,a0,-672 # 7388 <malloc+0x136e>
    3630:	00003097          	auipc	ra,0x3
    3634:	932080e7          	jalr	-1742(ra) # 5f62 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dec50513          	addi	a0,a0,-532 # 7430 <malloc+0x1416>
    364c:	00003097          	auipc	ra,0x3
    3650:	916080e7          	jalr	-1770(ra) # 5f62 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	df050513          	addi	a0,a0,-528 # 7450 <malloc+0x1436>
    3668:	00003097          	auipc	ra,0x3
    366c:	8fa080e7          	jalr	-1798(ra) # 5f62 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dec50513          	addi	a0,a0,-532 # 7468 <malloc+0x144e>
    3684:	00003097          	auipc	ra,0x3
    3688:	8de080e7          	jalr	-1826(ra) # 5f62 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f0c50513          	addi	a0,a0,-244 # 75b0 <malloc+0x1596>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dcc50513          	addi	a0,a0,-564 # 7480 <malloc+0x1466>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	dd450513          	addi	a0,a0,-556 # 74a0 <malloc+0x1486>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	ecc58593          	addi	a1,a1,-308 # 75b0 <malloc+0x1596>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d8250513          	addi	a0,a0,-638 # 7480 <malloc+0x1466>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	de650513          	addi	a0,a0,-538 # 74f8 <malloc+0x14de>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	df650513          	addi	a0,a0,-522 # 7520 <malloc+0x1506>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e0e58593          	addi	a1,a1,-498 # 7550 <malloc+0x1536>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dfa50513          	addi	a0,a0,-518 # 7558 <malloc+0x153e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e0258593          	addi	a1,a1,-510 # 75a8 <malloc+0x158e>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d7250513          	addi	a0,a0,-654 # 7520 <malloc+0x1506>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d5e50513          	addi	a0,a0,-674 # 7520 <malloc+0x1506>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d4850513          	addi	a0,a0,-696 # 7520 <malloc+0x1506>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c9450513          	addi	a0,a0,-876 # 7480 <malloc+0x1466>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e4050513          	addi	a0,a0,-448 # 7640 <malloc+0x1626>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e5c50513          	addi	a0,a0,-420 # 7670 <malloc+0x1656>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e7850513          	addi	a0,a0,-392 # 76a0 <malloc+0x1686>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d6a50513          	addi	a0,a0,-662 # 75a8 <malloc+0x158e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	ca850513          	addi	a0,a0,-856 # 7520 <malloc+0x1506>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	ea050513          	addi	a0,a0,-352 # 7730 <malloc+0x1716>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	eb850513          	addi	a0,a0,-328 # 7760 <malloc+0x1746>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	bc050513          	addi	a0,a0,-1088 # 7480 <malloc+0x1466>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	baa50513          	addi	a0,a0,-1110 # 7480 <malloc+0x1466>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b9450513          	addi	a0,a0,-1132 # 7480 <malloc+0x1466>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	ef058593          	addi	a1,a1,-272 # 77f0 <malloc+0x17d6>
    3908:	00004517          	auipc	a0,0x4
    390c:	e2850513          	addi	a0,a0,-472 # 7730 <malloc+0x1716>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ed458593          	addi	a1,a1,-300 # 77f0 <malloc+0x17d6>
    3924:	00004517          	auipc	a0,0x4
    3928:	e3c50513          	addi	a0,a0,-452 # 7760 <malloc+0x1746>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c7058593          	addi	a1,a1,-912 # 75a8 <malloc+0x158e>
    3940:	00004517          	auipc	a0,0x4
    3944:	b6050513          	addi	a0,a0,-1184 # 74a0 <malloc+0x1486>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	ddc50513          	addi	a0,a0,-548 # 7730 <malloc+0x1716>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	df850513          	addi	a0,a0,-520 # 7760 <malloc+0x1746>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c2c50513          	addi	a0,a0,-980 # 75a8 <malloc+0x158e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	dd050513          	addi	a0,a0,-560 # 7760 <malloc+0x1746>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d8c50513          	addi	a0,a0,-628 # 7730 <malloc+0x1716>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	ae850513          	addi	a0,a0,-1304 # 74a0 <malloc+0x1486>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f7450513          	addi	a0,a0,-140 # 7940 <malloc+0x1926>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	bc850513          	addi	a0,a0,-1080 # 75a8 <malloc+0x158e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	aac50513          	addi	a0,a0,-1364 # 74a0 <malloc+0x1486>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a7850513          	addi	a0,a0,-1416 # 7480 <malloc+0x1466>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f9450513          	addi	a0,a0,-108 # 79b0 <malloc+0x1996>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a5050513          	addi	a0,a0,-1456 # 7480 <malloc+0x1466>
    ...
    3a56:	a3650513          	addi	a0,a0,-1482 # 7488 <malloc+0x146e>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	508080e7          	jalr	1288(ra) # 5f62 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	a3a50513          	addi	a0,a0,-1478 # 74a8 <malloc+0x148e>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4ec080e7          	jalr	1260(ra) # 5f62 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	a3e50513          	addi	a0,a0,-1474 # 74c8 <malloc+0x14ae>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	4d0080e7          	jalr	1232(ra) # 5f62 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a5a50513          	addi	a0,a0,-1446 # 7500 <malloc+0x14e6>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	4b4080e7          	jalr	1204(ra) # 5f62 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a6e50513          	addi	a0,a0,-1426 # 7530 <malloc+0x1516>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	498080e7          	jalr	1176(ra) # 5f62 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a8a50513          	addi	a0,a0,-1398 # 7568 <malloc+0x154e>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	47c080e7          	jalr	1148(ra) # 5f62 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a8e50513          	addi	a0,a0,-1394 # 7588 <malloc+0x156e>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	460080e7          	jalr	1120(ra) # 5f62 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	aa250513          	addi	a0,a0,-1374 # 75b8 <malloc+0x159e>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	444080e7          	jalr	1092(ra) # 5f62 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	aae50513          	addi	a0,a0,-1362 # 75e0 <malloc+0x15c6>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	428080e7          	jalr	1064(ra) # 5f62 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	ab250513          	addi	a0,a0,-1358 # 7600 <malloc+0x15e6>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	40c080e7          	jalr	1036(ra) # 5f62 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	abe50513          	addi	a0,a0,-1346 # 7628 <malloc+0x160e>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3f0080e7          	jalr	1008(ra) # 5f62 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	aca50513          	addi	a0,a0,-1334 # 7650 <malloc+0x1636>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	3d4080e7          	jalr	980(ra) # 5f62 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	ade50513          	addi	a0,a0,-1314 # 7680 <malloc+0x1666>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	3b8080e7          	jalr	952(ra) # 5f62 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aea50513          	addi	a0,a0,-1302 # 76a8 <malloc+0x168e>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	39c080e7          	jalr	924(ra) # 5f62 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	ae650513          	addi	a0,a0,-1306 # 76c0 <malloc+0x16a6>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	380080e7          	jalr	896(ra) # 5f62 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aea50513          	addi	a0,a0,-1302 # 76e0 <malloc+0x16c6>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	364080e7          	jalr	868(ra) # 5f62 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	aee50513          	addi	a0,a0,-1298 # 7700 <malloc+0x16e6>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	348080e7          	jalr	840(ra) # 5f62 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	b1250513          	addi	a0,a0,-1262 # 7740 <malloc+0x1726>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	32c080e7          	jalr	812(ra) # 5f62 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	b2650513          	addi	a0,a0,-1242 # 7770 <malloc+0x1756>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	310080e7          	jalr	784(ra) # 5f62 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	b2a50513          	addi	a0,a0,-1238 # 7790 <malloc+0x1776>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2f4080e7          	jalr	756(ra) # 5f62 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	b2e50513          	addi	a0,a0,-1234 # 77b0 <malloc+0x1796>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	2d8080e7          	jalr	728(ra) # 5f62 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b3250513          	addi	a0,a0,-1230 # 77d0 <malloc+0x17b6>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	2bc080e7          	jalr	700(ra) # 5f62 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b4650513          	addi	a0,a0,-1210 # 7800 <malloc+0x17e6>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	2a0080e7          	jalr	672(ra) # 5f62 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b5250513          	addi	a0,a0,-1198 # 7828 <malloc+0x180e>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	284080e7          	jalr	644(ra) # 5f62 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b5e50513          	addi	a0,a0,-1186 # 7850 <malloc+0x1836>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	268080e7          	jalr	616(ra) # 5f62 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b6a50513          	addi	a0,a0,-1174 # 7878 <malloc+0x185e>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	24c080e7          	jalr	588(ra) # 5f62 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b6e50513          	addi	a0,a0,-1170 # 7898 <malloc+0x187e>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	230080e7          	jalr	560(ra) # 5f62 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b7250513          	addi	a0,a0,-1166 # 78b8 <malloc+0x189e>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	214080e7          	jalr	532(ra) # 5f62 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b7e50513          	addi	a0,a0,-1154 # 78e0 <malloc+0x18c6>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1f8080e7          	jalr	504(ra) # 5f62 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b8250513          	addi	a0,a0,-1150 # 7900 <malloc+0x18e6>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1dc080e7          	jalr	476(ra) # 5f62 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b8650513          	addi	a0,a0,-1146 # 7920 <malloc+0x1906>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1c0080e7          	jalr	448(ra) # 5f62 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b9250513          	addi	a0,a0,-1134 # 7948 <malloc+0x192e>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	1a4080e7          	jalr	420(ra) # 5f62 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	80e50513          	addi	a0,a0,-2034 # 75e0 <malloc+0x15c6>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	188080e7          	jalr	392(ra) # 5f62 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b7a50513          	addi	a0,a0,-1158 # 7968 <malloc+0x194e>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	16c080e7          	jalr	364(ra) # 5f62 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b7e50513          	addi	a0,a0,-1154 # 7988 <malloc+0x196e>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	150080e7          	jalr	336(ra) # 5f62 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b9250513          	addi	a0,a0,-1134 # 79b8 <malloc+0x199e>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	134080e7          	jalr	308(ra) # 5f62 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b9650513          	addi	a0,a0,-1130 # 79d8 <malloc+0x19be>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	118080e7          	jalr	280(ra) # 5f62 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b8850513          	addi	a0,a0,-1144 # 79f0 <malloc+0x19d6>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b7650513          	addi	a0,a0,-1162 # 79f0 <malloc+0x19d6>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	99450513          	addi	a0,a0,-1644 # 6820 <malloc+0x806>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5aa50513          	addi	a0,a0,1450 # 7448 <malloc+0x142e>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	54050513          	addi	a0,a0,1344 # 73f0 <malloc+0x13d6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b9650513          	addi	a0,a0,-1130 # 7a58 <malloc+0x1a3e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bac50513          	addi	a0,a0,-1108 # 7a80 <malloc+0x1a66>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b0a50513          	addi	a0,a0,-1270 # 79f0 <malloc+0x19d6>
    ...
    3f08:	af450513          	addi	a0,a0,-1292 # 79f8 <malloc+0x19de>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	056080e7          	jalr	86(ra) # 5f62 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	af050513          	addi	a0,a0,-1296 # 7a10 <malloc+0x19f6>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	03a080e7          	jalr	58(ra) # 5f62 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	aec50513          	addi	a0,a0,-1300 # 7a28 <malloc+0x1a0e>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	01e080e7          	jalr	30(ra) # 5f62 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	ae850513          	addi	a0,a0,-1304 # 7a40 <malloc+0x1a26>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	002080e7          	jalr	2(ra) # 5f62 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	48450513          	addi	a0,a0,1156 # 73f8 <malloc+0x13de>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	fe6080e7          	jalr	-26(ra) # 5f62 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ad050513          	addi	a0,a0,-1328 # 7a60 <malloc+0x1a46>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	fca080e7          	jalr	-54(ra) # 5f62 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	adc50513          	addi	a0,a0,-1316 # 7a88 <malloc+0x1a6e>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	fae080e7          	jalr	-82(ra) # 5f62 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	ae050513          	addi	a0,a0,-1312 # 7aa8 <malloc+0x1a8e>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f92080e7          	jalr	-110(ra) # 5f62 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	ad450513          	addi	a0,a0,-1324 # 7ac8 <malloc+0x1aae>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	ab850513          	addi	a0,a0,-1352 # 7ac8 <malloc+0x1aae>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	aec50513          	addi	a0,a0,-1300 # 7b10 <malloc+0x1af6>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	ad450513          	addi	a0,a0,-1324 # 7b10 <malloc+0x1af6>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	ac050513          	addi	a0,a0,-1344 # 7b10 <malloc+0x1af6>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	aac50513          	addi	a0,a0,-1364 # 7b10 <malloc+0x1af6>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a9858593          	addi	a1,a1,-1384 # 7b10 <malloc+0x1af6>
    4080:	00002517          	auipc	a0,0x2
    4084:	29050513          	addi	a0,a0,656 # 6310 <malloc+0x2f6>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a3450513          	addi	a0,a0,-1484 # 7ac8 <malloc+0x1aae>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	77650513          	addi	a0,a0,1910 # 6820 <malloc+0x806>
  ...
  fd = open(".", 0);
    ...
    40c4:	76050513          	addi	a0,a0,1888 # 6820 <malloc+0x806>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0d458593          	addi	a1,a1,212 # 61a8 <malloc+0x18e>
  ...
  close(fd);
    ...
    4104:	9d050513          	addi	a0,a0,-1584 # 7ad0 <malloc+0x1ab6>
    4108:	00002097          	auipc	ra,0x2
    410c:	e5a080e7          	jalr	-422(ra) # 5f62 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	9d450513          	addi	a0,a0,-1580 # 7af0 <malloc+0x1ad6>
    4124:	00002097          	auipc	ra,0x2
    4128:	e3e080e7          	jalr	-450(ra) # 5f62 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9e850513          	addi	a0,a0,-1560 # 7b20 <malloc+0x1b06>
    4140:	00002097          	auipc	ra,0x2
    4144:	e22080e7          	jalr	-478(ra) # 5f62 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	9cc50513          	addi	a0,a0,-1588 # 7b20 <malloc+0x1b06>
    415c:	00002097          	auipc	ra,0x2
    4160:	e06080e7          	jalr	-506(ra) # 5f62 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9d850513          	addi	a0,a0,-1576 # 7b48 <malloc+0x1b2e>
    4178:	00002097          	auipc	ra,0x2
    417c:	dea080e7          	jalr	-534(ra) # 5f62 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9e450513          	addi	a0,a0,-1564 # 7b70 <malloc+0x1b56>
    4194:	00002097          	auipc	ra,0x2
    4198:	dce080e7          	jalr	-562(ra) # 5f62 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9f050513          	addi	a0,a0,-1552 # 7b98 <malloc+0x1b7e>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	db2080e7          	jalr	-590(ra) # 5f62 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9fc50513          	addi	a0,a0,-1540 # 7bc0 <malloc+0x1ba6>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d96080e7          	jalr	-618(ra) # 5f62 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	a0050513          	addi	a0,a0,-1536 # 7be0 <malloc+0x1bc6>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d7a080e7          	jalr	-646(ra) # 5f62 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	a0c50513          	addi	a0,a0,-1524 # 7c08 <malloc+0x1bee>
    4204:	00002097          	auipc	ra,0x2
    4208:	d5e080e7          	jalr	-674(ra) # 5f62 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9f0a0a13          	addi	s4,s4,-1552 # 7c20 <malloc+0x1c06>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4f048493          	addi	s1,s1,1264 # 7728 <malloc+0x170e>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0d0a8a93          	addi	s5,s5,208 # 6310 <malloc+0x2f6>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8d098993          	addi	s3,s3,-1840 # 7b18 <malloc+0x1afe>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9d450513          	addi	a0,a0,-1580 # 7c28 <malloc+0x1c0e>
    425c:	00002097          	auipc	ra,0x2
    4260:	d06080e7          	jalr	-762(ra) # 5f62 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	9d050513          	addi	a0,a0,-1584 # 7c40 <malloc+0x1c26>
    4278:	00002097          	auipc	ra,0x2
    427c:	cea080e7          	jalr	-790(ra) # 5f62 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	14498993          	addi	s3,s3,324 # 7448 <malloc+0x142e>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	91490913          	addi	s2,s2,-1772 # 7c20 <malloc+0x1c06>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0c450513          	addi	a0,a0,196 # 73f0 <malloc+0x13d6>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8fc50513          	addi	a0,a0,-1796 # 7c58 <malloc+0x1c3e>
  ...
  if(pid == 0){
    ...
    4384:	8d850513          	addi	a0,a0,-1832 # 7c58 <malloc+0x1c3e>
    ...
    439a:	8e250513          	addi	a0,a0,-1822 # 7c78 <malloc+0x1c5e>
    439e:	00002097          	auipc	ra,0x2
    43a2:	bc4080e7          	jalr	-1084(ra) # 5f62 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	8ae50513          	addi	a0,a0,-1874 # 7c60 <malloc+0x1c46>
    43ba:	00002097          	auipc	ra,0x2
    43be:	ba8080e7          	jalr	-1112(ra) # 5f62 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5f250513          	addi	a0,a0,1522 # 69c0 <malloc+0x9a6>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b8c080e7          	jalr	-1140(ra) # 5f62 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	85c50513          	addi	a0,a0,-1956 # 7c58 <malloc+0x1c3e>
    ...
    4414:	7a050513          	addi	a0,a0,1952 # 6bb0 <malloc+0xb96>
    4418:	00002097          	auipc	ra,0x2
    441c:	b4a080e7          	jalr	-1206(ra) # 5f62 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	85250513          	addi	a0,a0,-1966 # 7ca0 <malloc+0x1c86>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	82650513          	addi	a0,a0,-2010 # 7ca0 <malloc+0x1c86>
  ...
  sleep(10); // one second
    ...
    44b6:	6ce50513          	addi	a0,a0,1742 # 6b80 <malloc+0xb66>
    44ba:	00002097          	auipc	ra,0x2
    44be:	aa8080e7          	jalr	-1368(ra) # 5f62 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	7d448493          	addi	s1,s1,2004 # 7ca0 <malloc+0x1c86>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	44c50513          	addi	a0,a0,1100 # 69c0 <malloc+0x9a6>
    457c:	00002097          	auipc	ra,0x2
    4580:	9e6080e7          	jalr	-1562(ra) # 5f62 <printf>
      exit(1);
    4584:	4505                	li	a0,1
    ...
    459e:	71650513          	addi	a0,a0,1814 # 7cb0 <malloc+0x1c96>
    45a2:	00002097          	auipc	ra,0x2
    45a6:	9c0080e7          	jalr	-1600(ra) # 5f62 <printf>
       exit(1);
    45aa:	4505                	li	a0,1
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	5a650513          	addi	a0,a0,1446 # 6b80 <malloc+0xb66>
    45e2:	00002097          	auipc	ra,0x2
    45e6:	980080e7          	jalr	-1664(ra) # 5f62 <printf>
    exit(1);
    45ea:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    460c:	3b850513          	addi	a0,a0,952 # 69c0 <malloc+0x9a6>
    4610:	00002097          	auipc	ra,0x2
    4614:	952080e7          	jalr	-1710(ra) # 5f62 <printf>
    exit(1);
    4618:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4650:	b5c58593          	addi	a1,a1,-1188 # 61a8 <malloc+0x18e>
    ...
    467a:	34a50513          	addi	a0,a0,842 # 69c0 <malloc+0x9a6>
    467e:	00002097          	auipc	ra,0x2
    4682:	8e4080e7          	jalr	-1820(ra) # 5f62 <printf>
     exit(1);
    4686:	4505                	li	a0,1
    ...
    4696:	63e50513          	addi	a0,a0,1598 # 7cd0 <malloc+0x1cb6>
    469a:	00002097          	auipc	ra,0x2
    469e:	8c8080e7          	jalr	-1848(ra) # 5f62 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	61a50513          	addi	a0,a0,1562 # 7ce8 <malloc+0x1cce>
    46d6:	00002097          	auipc	ra,0x2
    46da:	88c080e7          	jalr	-1908(ra) # 5f62 <printf>
}
  ...
  printf("kill... ");
    ...
    46fe:	60650513          	addi	a0,a0,1542 # 7d00 <malloc+0x1ce6>
    4702:	00002097          	auipc	ra,0x2
    4706:	860080e7          	jalr	-1952(ra) # 5f62 <printf>
  kill(pid1);
    470a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    472c:	5e850513          	addi	a0,a0,1512 # 7d10 <malloc+0x1cf6>
    4730:	00002097          	auipc	ra,0x2
    4734:	832080e7          	jalr	-1998(ra) # 5f62 <printf>
  wait(0);
    4738:	4501                	li	a0,0
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	21850513          	addi	a0,a0,536 # 69c0 <malloc+0x9a6>
    47b0:	00001097          	auipc	ra,0x1
    47b4:	7b2080e7          	jalr	1970(ra) # 5f62 <printf>
      exit(1);
    47b8:	4505                	li	a0,1
    ...
    47c8:	38450513          	addi	a0,a0,900 # 6b48 <malloc+0xb2e>
    47cc:	00001097          	auipc	ra,0x1
    47d0:	796080e7          	jalr	1942(ra) # 5f62 <printf>
        exit(1);
    47d4:	4505                	li	a0,1
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	28e50513          	addi	a0,a0,654 # 6ac8 <malloc+0xaae>
    4842:	00001097          	auipc	ra,0x1
    4846:	720080e7          	jalr	1824(ra) # 5f62 <printf>
    exit(1);
    484a:	4505                	li	a0,1
    ...
    4872:	93a58593          	addi	a1,a1,-1734 # 61a8 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	3ee50513          	addi	a0,a0,1006 # 7d20 <malloc+0x1d06>
    493a:	00001097          	auipc	ra,0x1
    493e:	628080e7          	jalr	1576(ra) # 5f62 <printf>
    exit(1);
    4942:	4505                	li	a0,1
    ...
    4952:	07250513          	addi	a0,a0,114 # 69c0 <malloc+0x9a6>
    4956:	00001097          	auipc	ra,0x1
    495a:	60c080e7          	jalr	1548(ra) # 5f62 <printf>
    exit(1);
    495e:	4505                	li	a0,1
    ...
    499e:	3a650513          	addi	a0,a0,934 # 7d40 <malloc+0x1d26>
    49a2:	00001097          	auipc	ra,0x1
    49a6:	5c0080e7          	jalr	1472(ra) # 5f62 <printf>
    exit(1);
    49aa:	4505                	li	a0,1
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a08:	616080e7          	jalr	1558(ra) # 601a <malloc>
    ...
    4a42:	33250513          	addi	a0,a0,818 # 7d70 <malloc+0x1d56>
    4a46:	00001097          	auipc	ra,0x1
    4a4a:	51c080e7          	jalr	1308(ra) # 5f62 <printf>
      exit(1);
    4a4e:	4505                	li	a0,1
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	2ac50513          	addi	a0,a0,684 # 7da0 <malloc+0x1d86>
    4afc:	00001097          	auipc	ra,0x1
    4b00:	466080e7          	jalr	1126(ra) # 5f62 <printf>
    exit(1);
    4b04:	4505                	li	a0,1
    ...
    4b14:	2b850513          	addi	a0,a0,696 # 7dc8 <malloc+0x1dae>
    4b18:	00001097          	auipc	ra,0x1
    4b1c:	44a080e7          	jalr	1098(ra) # 5f62 <printf>
      exit(1);
    4b20:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	23c50513          	addi	a0,a0,572 # 7d90 <malloc+0x1d76>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	25450513          	addi	a0,a0,596 # 7de8 <malloc+0x1dce>
    4b9c:	00001097          	auipc	ra,0x1
    4ba0:	3c6080e7          	jalr	966(ra) # 5f62 <printf>
    exit(1);
    4ba4:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bd4:	1c050513          	addi	a0,a0,448 # 7d90 <malloc+0x1d76>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	21a50513          	addi	a0,a0,538 # 7e10 <malloc+0x1df6>
    4bfe:	00001097          	auipc	ra,0x1
    4c02:	364080e7          	jalr	868(ra) # 5f62 <printf>
    exit(1);
    4c06:	4505                	li	a0,1
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	1ec78793          	addi	a5,a5,492 # 7e28 <malloc+0x1e0e>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1e878793          	addi	a5,a5,488 # 7e30 <malloc+0x1e16>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1e478793          	addi	a5,a5,484 # 7e38 <malloc+0x1e1e>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1e078793          	addi	a5,a5,480 # 7e40 <malloc+0x1e26>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	0f050513          	addi	a0,a0,240 # 6dc8 <malloc+0xdae>
    4ce0:	00001097          	auipc	ra,0x1
    4ce4:	282080e7          	jalr	642(ra) # 5f62 <printf>
      exit(1);
    4ce8:	4505                	li	a0,1
    ...
    4d58:	0f450513          	addi	a0,a0,244 # 7e48 <malloc+0x1e2e>
    4d5c:	00001097          	auipc	ra,0x1
    4d60:	206080e7          	jalr	518(ra) # 5f62 <printf>
        exit(1);
    4d64:	4505                	li	a0,1
    ...
    4d72:	0ea50513          	addi	a0,a0,234 # 7e58 <malloc+0x1e3e>
    4d76:	00001097          	auipc	ra,0x1
    4d7a:	1ec080e7          	jalr	492(ra) # 5f62 <printf>
          exit(1);
    4d7e:	4505                	li	a0,1
    ...
    4d9a:	0da50513          	addi	a0,a0,218 # 7e70 <malloc+0x1e56>
    4d9e:	00001097          	auipc	ra,0x1
    4da2:	1c4080e7          	jalr	452(ra) # 5f62 <printf>
          exit(1);
    4da6:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	05c50513          	addi	a0,a0,92 # 7e80 <malloc+0x1e66>
    4e2c:	00001097          	auipc	ra,0x1
    4e30:	136080e7          	jalr	310(ra) # 5f62 <printf>
      exit(1);
    4e34:	4505                	li	a0,1
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	012b8b93          	addi	s7,s7,18 # 7e98 <malloc+0x1e7e>
  for(i = 0; i < N; i++){
    ...
    4ecc:	fd850513          	addi	a0,a0,-40 # 7ea0 <malloc+0x1e86>
    4ed0:	00001097          	auipc	ra,0x1
    4ed4:	092080e7          	jalr	146(ra) # 5f62 <printf>
        exit(1);
    4ed8:	4505                	li	a0,1
    ...
    4eea:	fb250513          	addi	a0,a0,-78 # 7e98 <malloc+0x1e7e>
  ...
  fd = open(".", 0);
    ...
    4f22:	90250513          	addi	a0,a0,-1790 # 6820 <malloc+0x806>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f2a50513          	addi	a0,a0,-214 # 7ec0 <malloc+0x1ea6>
    4f9e:	00001097          	auipc	ra,0x1
    4fa2:	fc4080e7          	jalr	-60(ra) # 5f62 <printf>
        exit(1);
    4fa6:	4505                	li	a0,1
    ...
    4fba:	f2a50513          	addi	a0,a0,-214 # 7ee0 <malloc+0x1ec6>
    4fbe:	00001097          	auipc	ra,0x1
    4fc2:	fa4080e7          	jalr	-92(ra) # 5f62 <printf>
        exit(1);
    4fc6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	f1a50513          	addi	a0,a0,-230 # 7f08 <malloc+0x1eee>
    4ff6:	00001097          	auipc	ra,0x1
    4ffa:	f6c080e7          	jalr	-148(ra) # 5f62 <printf>
    exit(1);
    4ffe:	4505                	li	a0,1
    ...
    500e:	9b650513          	addi	a0,a0,-1610 # 69c0 <malloc+0x9a6>
    5012:	00001097          	auipc	ra,0x1
    5016:	f50080e7          	jalr	-176(ra) # 5f62 <printf>
      exit(1);
    501a:	4505                	li	a0,1
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d0450513          	addi	a0,a0,-764 # 7f40 <malloc+0x1f26>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	cb050513          	addi	a0,a0,-848 # 7f50 <malloc+0x1f36>
    52a8:	00001097          	auipc	ra,0x1
    52ac:	cba080e7          	jalr	-838(ra) # 5f62 <printf>
    exit(1);
    52b0:	4505                	li	a0,1
    ...
    52c0:	cb450513          	addi	a0,a0,-844 # 7f70 <malloc+0x1f56>
    52c4:	00001097          	auipc	ra,0x1
    52c8:	c9e080e7          	jalr	-866(ra) # 5f62 <printf>
      exit(1);
    52cc:	4505                	li	a0,1
    ...
    52dc:	cb850513          	addi	a0,a0,-840 # 7f90 <malloc+0x1f76>
    52e0:	00001097          	auipc	ra,0x1
    52e4:	c82080e7          	jalr	-894(ra) # 5f62 <printf>
    exit(1);
    52e8:	4505                	li	a0,1
    ...
    52f8:	cbc50513          	addi	a0,a0,-836 # 7fb0 <malloc+0x1f96>
    52fc:	00001097          	auipc	ra,0x1
    5300:	c66080e7          	jalr	-922(ra) # 5f62 <printf>
      exit(1);
    5304:	4505                	li	a0,1
    ...
    5314:	cc050513          	addi	a0,a0,-832 # 7fd0 <malloc+0x1fb6>
    5318:	00001097          	auipc	ra,0x1
    531c:	c4a080e7          	jalr	-950(ra) # 5f62 <printf>
      exit(1);
    5320:	4505                	li	a0,1
    ...
    5330:	cbc50513          	addi	a0,a0,-836 # 7fe8 <malloc+0x1fce>
    5334:	00001097          	auipc	ra,0x1
    5338:	c2e080e7          	jalr	-978(ra) # 5f62 <printf>
      exit(1);
    533c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    535e:	be650513          	addi	a0,a0,-1050 # 7f40 <malloc+0x1f26>
    ...
    5382:	c8a50513          	addi	a0,a0,-886 # 8008 <malloc+0x1fee>
    5386:	00001097          	auipc	ra,0x1
    538a:	bdc080e7          	jalr	-1060(ra) # 5f62 <printf>
    exit(1);
    538e:	4505                	li	a0,1
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	c7250513          	addi	a0,a0,-910 # 8028 <malloc+0x200e>
    53be:	00001097          	auipc	ra,0x1
    53c2:	ba4080e7          	jalr	-1116(ra) # 5f62 <printf>
  for(nfiles = 0; ; nfiles++){
    53c6:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53da:	c62c8c93          	addi	s9,s9,-926 # 8038 <malloc+0x201e>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5432:	b34080e7          	jalr	-1228(ra) # 5f62 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5454:	bf850513          	addi	a0,a0,-1032 # 8048 <malloc+0x202e>
    5458:	00001097          	auipc	ra,0x1
    545c:	b0a080e7          	jalr	-1270(ra) # 5f62 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	ba250513          	addi	a0,a0,-1118 # 8068 <malloc+0x204e>
    54ce:	00001097          	auipc	ra,0x1
    54d2:	a94080e7          	jalr	-1388(ra) # 5f62 <printf>
}
    ...
    551a:	b4250513          	addi	a0,a0,-1214 # 8058 <malloc+0x203e>
    551e:	00001097          	auipc	ra,0x1
    5522:	a44080e7          	jalr	-1468(ra) # 5f62 <printf>
    close(fd);
    5526:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	b3850513          	addi	a0,a0,-1224 # 8080 <malloc+0x2066>
    5550:	00001097          	auipc	ra,0x1
    5554:	a12080e7          	jalr	-1518(ra) # 5f62 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    557c:	b3050513          	addi	a0,a0,-1232 # 80a8 <malloc+0x208e>
    5580:	00001097          	auipc	ra,0x1
    5584:	9e2080e7          	jalr	-1566(ra) # 5f62 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a0:	af450513          	addi	a0,a0,-1292 # 8090 <malloc+0x2076>
    55a4:	00001097          	auipc	ra,0x1
    55a8:	9be080e7          	jalr	-1602(ra) # 5f62 <printf>
    exit(1);
    55ac:	4505                	li	a0,1
    ...
    55c8:	aec50513          	addi	a0,a0,-1300 # 80b0 <malloc+0x2096>
    55cc:	00001097          	auipc	ra,0x1
    55d0:	996080e7          	jalr	-1642(ra) # 5f62 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	aa450513          	addi	a0,a0,-1372 # 80b8 <malloc+0x209e>
    561c:	00001097          	auipc	ra,0x1
    5620:	946080e7          	jalr	-1722(ra) # 5f62 <printf>
        return 1;
    5624:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	b3a98993          	addi	s3,s3,-1222 # 61a8 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	a7050513          	addi	a0,a0,-1424 # 8110 <malloc+0x20f6>
    56a8:	00001097          	auipc	ra,0x1
    56ac:	8ba080e7          	jalr	-1862(ra) # 5f62 <printf>
        exit(1);
    56b0:	4505                	li	a0,1
    ...
    56be:	a1650513          	addi	a0,a0,-1514 # 80d0 <malloc+0x20b6>
    56c2:	00001097          	auipc	ra,0x1
    56c6:	8a0080e7          	jalr	-1888(ra) # 5f62 <printf>
    exit(1);
    56ca:	4505                	li	a0,1
    ...
    56d8:	a1c50513          	addi	a0,a0,-1508 # 80f0 <malloc+0x20d6>
    56dc:	00001097          	auipc	ra,0x1
    56e0:	886080e7          	jalr	-1914(ra) # 5f62 <printf>
    exit(1);
    56e4:	4505                	li	a0,1
  ...
  while(1){
    ...
    5726:	a0e50513          	addi	a0,a0,-1522 # 8130 <malloc+0x2116>
    572a:	00001097          	auipc	ra,0x1
    572e:	838080e7          	jalr	-1992(ra) # 5f62 <printf>
      exit(1);
    5732:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	9ccb8b93          	addi	s7,s7,-1588 # 8150 <malloc+0x2136>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d2:	794080e7          	jalr	1940(ra) # 5f62 <printf>
    int free0 = countfree();
    ...
    5822:	744080e7          	jalr	1860(ra) # 5f62 <printf>
      if(continuous != 2) {
    ...
    5832:	734080e7          	jalr	1844(ra) # 5f62 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	91e58593          	addi	a1,a1,-1762 # 81b8 <malloc+0x219e>
    ...
    58b6:	95e58593          	addi	a1,a1,-1698 # 8210 <malloc+0x21f6>
    ...
    58cc:	94058593          	addi	a1,a1,-1728 # 8208 <malloc+0x21ee>
  ...
  int continuous = 0;
    ...
    58f8:	8cc50513          	addi	a0,a0,-1844 # 81c0 <malloc+0x21a6>
    58fc:	00000097          	auipc	ra,0x0
    5900:	666080e7          	jalr	1638(ra) # 5f62 <printf>
    exit(1);
    5904:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	8d050513          	addi	a0,a0,-1840 # 81f0 <malloc+0x21d6>
    5928:	00000097          	auipc	ra,0x0
    592c:	63a080e7          	jalr	1594(ra) # 5f62 <printf>
  exit(0);
    5930:	4501                	li	a0,0
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5c9e:	f46080e7          	jalr	-186(ra) # 5be0 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    5cbc:	0805c963          	bltz	a1,5d4e <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5cd0:	90c50513          	addi	a0,a0,-1780 # 85d8 <digits>
    5cd4:	883a                	mv	a6,a4
  ...
  if(neg)
    5cf8:	00088c63          	beqz	a7,5d10 <printint+0x66>
    buf[i++] = '-';
    5cfc:	fd070793          	addi	a5,a4,-48
    5d00:	00878733          	add	a4,a5,s0
    5d04:	02d00793          	li	a5,45
    5d08:	fef70823          	sb	a5,-16(a4)
    5d0c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d10:	02e05863          	blez	a4,5d40 <printint+0x96>
    5d14:	fc040793          	addi	a5,s0,-64
    5d18:	00e78933          	add	s2,a5,a4
    5d1c:	fff78993          	addi	s3,a5,-1
    5d20:	99ba                	add	s3,s3,a4
    5d22:	377d                	addiw	a4,a4,-1
    5d24:	1702                	slli	a4,a4,0x20
    5d26:	9301                	srli	a4,a4,0x20
    5d28:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d2c:	fff94583          	lbu	a1,-1(s2)
    5d30:	8526                	mv	a0,s1
    5d32:	00000097          	auipc	ra,0x0
    5d36:	f56080e7          	jalr	-170(ra) # 5c88 <putc>
  while(--i >= 0)
    5d3a:	197d                	addi	s2,s2,-1
    5d3c:	ff3918e3          	bne	s2,s3,5d2c <printint+0x82>
}
    ...
    5d4a:	6121                	addi	sp,sp,64
    5d4c:	8082                	ret
    x = -xx;
    5d4e:	40b005bb          	negw	a1,a1
    neg = 1;
    5d52:	4885                	li	a7,1
    x = -xx;
    5d54:	bf85                	j	5cc4 <printint+0x1a>

0000000000005d56 <vprintf>:
}
...
{
    5d56:	7119                	addi	sp,sp,-128
    5d58:	fc86                	sd	ra,120(sp)
    5d5a:	f8a2                	sd	s0,112(sp)
    5d5c:	f4a6                	sd	s1,104(sp)
    5d5e:	f0ca                	sd	s2,96(sp)
    5d60:	ecce                	sd	s3,88(sp)
    5d62:	e8d2                	sd	s4,80(sp)
    5d64:	e4d6                	sd	s5,72(sp)
    5d66:	e0da                	sd	s6,64(sp)
    5d68:	fc5e                	sd	s7,56(sp)
    5d6a:	f862                	sd	s8,48(sp)
    5d6c:	f466                	sd	s9,40(sp)
    5d6e:	f06a                	sd	s10,32(sp)
    5d70:	ec6e                	sd	s11,24(sp)
    5d72:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5d74:	0005c903          	lbu	s2,0(a1)
    5d78:	18090f63          	beqz	s2,5f16 <vprintf+0x1c0>
    5d7c:	8aaa                	mv	s5,a0
    5d7e:	8b32                	mv	s6,a2
    5d80:	00158493          	addi	s1,a1,1
  state = 0;
    5d84:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d86:	02500a13          	li	s4,37
    5d8a:	4c55                	li	s8,21
    5d8c:	00002c97          	auipc	s9,0x2
    5d90:	7f4c8c93          	addi	s9,s9,2036 # 8580 <malloc+0x2566>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5d94:	02800d93          	li	s11,40
  putc(fd, 'x');
    5d98:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d9a:	00003b97          	auipc	s7,0x3
    5d9e:	83eb8b93          	addi	s7,s7,-1986 # 85d8 <digits>
    5da2:	a839                	j	5dc0 <vprintf+0x6a>
        putc(fd, c);
    5da4:	85ca                	mv	a1,s2
    5da6:	8556                	mv	a0,s5
    5da8:	00000097          	auipc	ra,0x0
    5dac:	ee0080e7          	jalr	-288(ra) # 5c88 <putc>
    5db0:	a019                	j	5db6 <vprintf+0x60>
    } else if(state == '%'){
    5db2:	01498d63          	beq	s3,s4,5dcc <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5db6:	0485                	addi	s1,s1,1
    5db8:	fff4c903          	lbu	s2,-1(s1)
    5dbc:	14090d63          	beqz	s2,5f16 <vprintf+0x1c0>
    if(state == 0){
    5dc0:	fe0999e3          	bnez	s3,5db2 <vprintf+0x5c>
      if(c == '%'){
    5dc4:	ff4910e3          	bne	s2,s4,5da4 <vprintf+0x4e>
        state = '%';
    5dc8:	89d2                	mv	s3,s4
    5dca:	b7f5                	j	5db6 <vprintf+0x60>
      if(c == 'd'){
    5dcc:	11490c63          	beq	s2,s4,5ee4 <vprintf+0x18e>
    5dd0:	f9d9079b          	addiw	a5,s2,-99
    5dd4:	0ff7f793          	zext.b	a5,a5
    5dd8:	10fc6e63          	bltu	s8,a5,5ef4 <vprintf+0x19e>
    5ddc:	f9d9079b          	addiw	a5,s2,-99
    5de0:	0ff7f713          	zext.b	a4,a5
    5de4:	10ec6863          	bltu	s8,a4,5ef4 <vprintf+0x19e>
    5de8:	00271793          	slli	a5,a4,0x2
    5dec:	97e6                	add	a5,a5,s9
    5dee:	439c                	lw	a5,0(a5)
    5df0:	97e6                	add	a5,a5,s9
    5df2:	8782                	jr	a5
    ...
    5e06:	ea8080e7          	jalr	-344(ra) # 5caa <printint>
    5e0a:	8b4a                	mv	s6,s2
      } else {
    ...
    5e22:	e8c080e7          	jalr	-372(ra) # 5caa <printint>
    5e26:	8b4a                	mv	s6,s2
      state = 0;
    5e28:	4981                	li	s3,0
    5e2a:	b771                	j	5db6 <vprintf+0x60>
    ...
    5e3e:	e70080e7          	jalr	-400(ra) # 5caa <printint>
    5e42:	8b4a                	mv	s6,s2
      state = 0;
    5e44:	4981                	li	s3,0
    5e46:	bf85                	j	5db6 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5e5e:	e2e080e7          	jalr	-466(ra) # 5c88 <putc>
  putc(fd, 'x');
    5e62:	07800593          	li	a1,120
    5e66:	8556                	mv	a0,s5
    5e68:	00000097          	auipc	ra,0x0
    5e6c:	e20080e7          	jalr	-480(ra) # 5c88 <putc>
    5e70:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5e82:	e0a080e7          	jalr	-502(ra) # 5c88 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e86:	0992                	slli	s3,s3,0x4
    5e88:	397d                	addiw	s2,s2,-1
    5e8a:	fe0914e3          	bnez	s2,5e72 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5e8e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5e92:	4981                	li	s3,0
    5e94:	b70d                	j	5db6 <vprintf+0x60>
        s = va_arg(ap, char*);
    5e96:	008b0913          	addi	s2,s6,8
    5e9a:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5e9e:	02098163          	beqz	s3,5ec0 <vprintf+0x16a>
        while(*s != 0){
    5ea2:	0009c583          	lbu	a1,0(s3)
    5ea6:	c5ad                	beqz	a1,5f10 <vprintf+0x1ba>
          putc(fd, *s);
    5ea8:	8556                	mv	a0,s5
    5eaa:	00000097          	auipc	ra,0x0
    5eae:	dde080e7          	jalr	-546(ra) # 5c88 <putc>
          s++;
    5eb2:	0985                	addi	s3,s3,1
        while(*s != 0){
    5eb4:	0009c583          	lbu	a1,0(s3)
    5eb8:	f9e5                	bnez	a1,5ea8 <vprintf+0x152>
        s = va_arg(ap, char*);
    5eba:	8b4a                	mv	s6,s2
      state = 0;
    5ebc:	4981                	li	s3,0
    5ebe:	bde5                	j	5db6 <vprintf+0x60>
          s = "(null)";
    5ec0:	00002997          	auipc	s3,0x2
    5ec4:	6b898993          	addi	s3,s3,1720 # 8578 <malloc+0x255e>
        while(*s != 0){
    5ec8:	85ee                	mv	a1,s11
    5eca:	bff9                	j	5ea8 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5ecc:	008b0913          	addi	s2,s6,8
    5ed0:	000b4583          	lbu	a1,0(s6)
    5ed4:	8556                	mv	a0,s5
    5ed6:	00000097          	auipc	ra,0x0
    5eda:	db2080e7          	jalr	-590(ra) # 5c88 <putc>
    5ede:	8b4a                	mv	s6,s2
      state = 0;
    5ee0:	4981                	li	s3,0
    5ee2:	bdd1                	j	5db6 <vprintf+0x60>
        putc(fd, c);
    5ee4:	85d2                	mv	a1,s4
    5ee6:	8556                	mv	a0,s5
    5ee8:	00000097          	auipc	ra,0x0
    5eec:	da0080e7          	jalr	-608(ra) # 5c88 <putc>
      state = 0;
    5ef0:	4981                	li	s3,0
    5ef2:	b5d1                	j	5db6 <vprintf+0x60>
        putc(fd, '%');
    5ef4:	85d2                	mv	a1,s4
    5ef6:	8556                	mv	a0,s5
    5ef8:	00000097          	auipc	ra,0x0
    5efc:	d90080e7          	jalr	-624(ra) # 5c88 <putc>
        putc(fd, c);
    5f00:	85ca                	mv	a1,s2
    5f02:	8556                	mv	a0,s5
    5f04:	00000097          	auipc	ra,0x0
    5f08:	d84080e7          	jalr	-636(ra) # 5c88 <putc>
      state = 0;
    5f0c:	4981                	li	s3,0
    5f0e:	b565                	j	5db6 <vprintf+0x60>
        s = va_arg(ap, char*);
    5f10:	8b4a                	mv	s6,s2
      state = 0;
    5f12:	4981                	li	s3,0
    5f14:	b54d                	j	5db6 <vprintf+0x60>
    }
  }
}
    5f16:	70e6                	ld	ra,120(sp)
    5f18:	7446                	ld	s0,112(sp)
    5f1a:	74a6                	ld	s1,104(sp)
    5f1c:	7906                	ld	s2,96(sp)
    5f1e:	69e6                	ld	s3,88(sp)
    5f20:	6a46                	ld	s4,80(sp)
    5f22:	6aa6                	ld	s5,72(sp)
    5f24:	6b06                	ld	s6,64(sp)
    5f26:	7be2                	ld	s7,56(sp)
    5f28:	7c42                	ld	s8,48(sp)
    5f2a:	7ca2                	ld	s9,40(sp)
    5f2c:	7d02                	ld	s10,32(sp)
    5f2e:	6de2                	ld	s11,24(sp)
    5f30:	6109                	addi	sp,sp,128
    5f32:	8082                	ret

0000000000005f34 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f34:	715d                	addi	sp,sp,-80
    5f36:	ec06                	sd	ra,24(sp)
    5f38:	e822                	sd	s0,16(sp)
    5f3a:	1000                	addi	s0,sp,32
    5f3c:	e010                	sd	a2,0(s0)
    5f3e:	e414                	sd	a3,8(s0)
    5f40:	e818                	sd	a4,16(s0)
    5f42:	ec1c                	sd	a5,24(s0)
    5f44:	03043023          	sd	a6,32(s0)
    5f48:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f4c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f50:	8622                	mv	a2,s0
    5f52:	00000097          	auipc	ra,0x0
    5f56:	e04080e7          	jalr	-508(ra) # 5d56 <vprintf>
}
    5f5a:	60e2                	ld	ra,24(sp)
    5f5c:	6442                	ld	s0,16(sp)
    5f5e:	6161                	addi	sp,sp,80
    5f60:	8082                	ret

0000000000005f62 <printf>:

void
printf(const char *fmt, ...)
{
    5f62:	711d                	addi	sp,sp,-96
    5f64:	ec06                	sd	ra,24(sp)
    5f66:	e822                	sd	s0,16(sp)
    5f68:	1000                	addi	s0,sp,32
    5f6a:	e40c                	sd	a1,8(s0)
    5f6c:	e810                	sd	a2,16(s0)
    5f6e:	ec14                	sd	a3,24(s0)
    5f70:	f018                	sd	a4,32(s0)
    5f72:	f41c                	sd	a5,40(s0)
    5f74:	03043823          	sd	a6,48(s0)
    5f78:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f7c:	00840613          	addi	a2,s0,8
    5f80:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f84:	85aa                	mv	a1,a0
    5f86:	4505                	li	a0,1
    5f88:	00000097          	auipc	ra,0x0
    5f8c:	dce080e7          	jalr	-562(ra) # 5d56 <vprintf>
}
    5f90:	60e2                	ld	ra,24(sp)
    5f92:	6442                	ld	s0,16(sp)
    5f94:	6125                	addi	sp,sp,96
    5f96:	8082                	ret

0000000000005f98 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f98:	1141                	addi	sp,sp,-16
    5f9a:	e422                	sd	s0,8(sp)
    5f9c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f9e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fa2:	00003797          	auipc	a5,0x3
    5fa6:	4ae7b783          	ld	a5,1198(a5) # 9450 <freep>
    5faa:	a02d                	j	5fd4 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fac:	4618                	lw	a4,8(a2)
    5fae:	9f2d                	addw	a4,a4,a1
    5fb0:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fb4:	6398                	ld	a4,0(a5)
    5fb6:	6310                	ld	a2,0(a4)
    5fb8:	a83d                	j	5ff6 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fba:	ff852703          	lw	a4,-8(a0)
    5fbe:	9f31                	addw	a4,a4,a2
    5fc0:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fc2:	ff053683          	ld	a3,-16(a0)
    5fc6:	a091                	j	600a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fc8:	6398                	ld	a4,0(a5)
    5fca:	00e7e463          	bltu	a5,a4,5fd2 <free+0x3a>
    5fce:	00e6ea63          	bltu	a3,a4,5fe2 <free+0x4a>
{
    5fd2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fd4:	fed7fae3          	bgeu	a5,a3,5fc8 <free+0x30>
    5fd8:	6398                	ld	a4,0(a5)
    5fda:	00e6e463          	bltu	a3,a4,5fe2 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fde:	fee7eae3          	bltu	a5,a4,5fd2 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5fe2:	ff852583          	lw	a1,-8(a0)
    5fe6:	6390                	ld	a2,0(a5)
    5fe8:	02059813          	slli	a6,a1,0x20
    5fec:	01c85713          	srli	a4,a6,0x1c
    5ff0:	9736                	add	a4,a4,a3
    5ff2:	fae60de3          	beq	a2,a4,5fac <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5ff6:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5ffa:	4790                	lw	a2,8(a5)
    5ffc:	02061593          	slli	a1,a2,0x20
    6000:	01c5d713          	srli	a4,a1,0x1c
    6004:	973e                	add	a4,a4,a5
    6006:	fae68ae3          	beq	a3,a4,5fba <free+0x22>
    p->s.ptr = bp->s.ptr;
    600a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    600c:	00003717          	auipc	a4,0x3
    6010:	44f73223          	sd	a5,1092(a4) # 9450 <freep>
}
    6014:	6422                	ld	s0,8(sp)
    6016:	0141                	addi	sp,sp,16
    6018:	8082                	ret

000000000000601a <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    601a:	7139                	addi	sp,sp,-64
    601c:	fc06                	sd	ra,56(sp)
    601e:	f822                	sd	s0,48(sp)
    6020:	f426                	sd	s1,40(sp)
    6022:	f04a                	sd	s2,32(sp)
    6024:	ec4e                	sd	s3,24(sp)
    6026:	e852                	sd	s4,16(sp)
    6028:	e456                	sd	s5,8(sp)
    602a:	e05a                	sd	s6,0(sp)
    602c:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    602e:	02051493          	slli	s1,a0,0x20
    6032:	9081                	srli	s1,s1,0x20
    6034:	04bd                	addi	s1,s1,15
    6036:	8091                	srli	s1,s1,0x4
    6038:	0014899b          	addiw	s3,s1,1
    603c:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    603e:	00003517          	auipc	a0,0x3
    6042:	41253503          	ld	a0,1042(a0) # 9450 <freep>
    6046:	c515                	beqz	a0,6072 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6048:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    604a:	4798                	lw	a4,8(a5)
    604c:	02977f63          	bgeu	a4,s1,608a <malloc+0x70>
    6050:	8a4e                	mv	s4,s3
    6052:	0009871b          	sext.w	a4,s3
    6056:	6685                	lui	a3,0x1
    6058:	00d77363          	bgeu	a4,a3,605e <malloc+0x44>
    605c:	6a05                	lui	s4,0x1
    605e:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6062:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    6066:	00003917          	auipc	s2,0x3
    606a:	3ea90913          	addi	s2,s2,1002 # 9450 <freep>
  if(p == (char*)-1)
    606e:	5afd                	li	s5,-1
    6070:	a895                	j	60e4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6072:	0000a797          	auipc	a5,0xa
    6076:	c0678793          	addi	a5,a5,-1018 # fc78 <base>
    607a:	00003717          	auipc	a4,0x3
    607e:	3cf73b23          	sd	a5,982(a4) # 9450 <freep>
    6082:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6084:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    6088:	b7e1                	j	6050 <malloc+0x36>
      if(p->s.size == nunits)
    608a:	02e48c63          	beq	s1,a4,60c2 <malloc+0xa8>
        p->s.size -= nunits;
    608e:	4137073b          	subw	a4,a4,s3
    6092:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6094:	02071693          	slli	a3,a4,0x20
    6098:	01c6d713          	srli	a4,a3,0x1c
    ...
    60c6:	bff1                	j	60a2 <malloc+0x88>
  hp->s.size = nu;
    60c8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60cc:	0541                	addi	a0,a0,16
    60ce:	00000097          	auipc	ra,0x0
    60d2:	eca080e7          	jalr	-310(ra) # 5f98 <free>
  return freep;
    60d6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60da:	d971                	beqz	a0,60ae <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60dc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60de:	4798                	lw	a4,8(a5)
    60e0:	fa9775e3          	bgeu	a4,s1,608a <malloc+0x70>
    if(p == freep)
    60e4:	00093703          	ld	a4,0(s2)
    60e8:	853e                	mv	a0,a5
    60ea:	fef719e3          	bne	a4,a5,60dc <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60ee:	8552                	mv	a0,s4
    60f0:	00000097          	auipc	ra,0x0
    60f4:	b58080e7          	jalr	-1192(ra) # 5c48 <sbrk>
  if(p == (char*)-1)
    60f8:	fd5518e3          	bne	a0,s5,60c8 <malloc+0xae>
        return 0;
    60fc:	4501                	li	a0,0
    60fe:	bf45                	j	60ae <malloc+0x94>
