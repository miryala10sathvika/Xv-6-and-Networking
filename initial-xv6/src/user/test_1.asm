...
main(int argc, char *argv[]) {
  ...
  6e:	7e650513          	addi	a0,a0,2022 # 850 <malloc+0xec>
  72:	00000097          	auipc	ra,0x0
  76:	63a080e7          	jalr	1594(ra) # 6ac <printf>
    exit(0);
  7a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	4ba50513          	addi	a0,a0,1210 # 8d0 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	3a2c8c93          	addi	s9,s9,930 # 878 <malloc+0x114>
 ...
 4e8:	3ecb8b93          	addi	s7,s7,1004 # 8d0 <digits>
 ...
 60e:	26698993          	addi	s3,s3,614 # 870 <malloc+0x10c>
        while(*s != 0){
 612:	85ee                	mv	a1,s11
