...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	31e58593          	addi	a1,a1,798 # 1330 <malloc+0xf2>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d858593          	addi	a1,a1,728 # 1338 <malloc+0xfa>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2a650513          	addi	a0,a0,678 # 1340 <malloc+0x102>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37a70713          	addi	a4,a4,890 # 1440 <malloc+0x202>
    ...
    panic("runcmd");
      ...
      e4:	26850513          	addi	a0,a0,616 # 1348 <malloc+0x10a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24e58593          	addi	a1,a1,590 # 1350 <malloc+0x112>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	21258593          	addi	a1,a1,530 # 1360 <malloc+0x122>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	18c50513          	addi	a0,a0,396 # 1370 <malloc+0x132>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	decb8b93          	addi	s7,s7,-532 # 1398 <malloc+0x15a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dba50513          	addi	a0,a0,-582 # 1378 <malloc+0x13a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	cfa60613          	addi	a2,a2,-774 # 13a0 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	ceab0b13          	addi	s6,s6,-790 # 13c0 <malloc+0x182>
  ...
  return ret;
     ...
     714:	c9850513          	addi	a0,a0,-872 # 13a8 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     776:	c3e50513          	addi	a0,a0,-962 # 13b0 <malloc+0x172>
...
0000000000000790 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b0:	c1c60613          	addi	a2,a2,-996 # 13c8 <malloc+0x18a>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     820:	bb4a0a13          	addi	s4,s4,-1100 # 13d0 <malloc+0x192>
  ...
  if(peek(ps, es, ";")){
     ...
     856:	b8660613          	addi	a2,a2,-1146 # 13d8 <malloc+0x19a>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8bc:	ae860613          	addi	a2,a2,-1304 # 13a0 <malloc+0x162>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ec:	b0860613          	addi	a2,a2,-1272 # 13f0 <malloc+0x1b2>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92e:	ab650513          	addi	a0,a0,-1354 # 13e0 <malloc+0x1a2>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
    panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	abe50513          	addi	a0,a0,-1346 # 13f8 <malloc+0x1ba>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96a:	af270713          	addi	a4,a4,-1294 # 1458 <malloc+0x21a>
...
00000000000009e2 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a16:	9fe60613          	addi	a2,a2,-1538 # 1410 <malloc+0x1d2>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	9d058593          	addi	a1,a1,-1584 # 1418 <malloc+0x1da>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	706080e7          	jalr	1798(ra) # 1158 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	94e50513          	addi	a0,a0,-1714 # 13a8 <malloc+0x16a>
...
0000000000000a6a <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	9ac48493          	addi	s1,s1,-1620 # 1428 <malloc+0x1ea>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     abe:	976a8a93          	addi	s5,s5,-1674 # 1430 <malloc+0x1f2>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	626080e7          	jalr	1574(ra) # 1158 <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ec2:	f46080e7          	jalr	-186(ra) # e04 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ee0:	0805c963          	bltz	a1,f72 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  if(neg)
     f1c:	00088c63          	beqz	a7,f34 <printint+0x66>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     f34:	02e05863          	blez	a4,f64 <printint+0x96>
    ...
    putc(fd, buf[i]);
     ...
     f5a:	f56080e7          	jalr	-170(ra) # eac <putc>
  while(--i >= 0)
     f5e:	197d                	addi	s2,s2,-1
     f60:	ff3918e3          	bne	s2,s3,f50 <printint+0x82>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fae:	4c55                	li	s8,21
     fb0:	00000c97          	auipc	s9,0x0
     fb4:	4c8c8c93          	addi	s9,s9,1224 # 1478 <malloc+0x23a>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
     fb8:	02800d93          	li	s11,40
  putc(fd, 'x');
     fbc:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fbe:	00000b97          	auipc	s7,0x0
     fc2:	512b8b93          	addi	s7,s7,1298 # 14d0 <digits>
     fc6:	a839                	j	fe4 <vprintf+0x6a>
        putc(fd, c);
     fc8:	85ca                	mv	a1,s2
     fca:	8556                	mv	a0,s5
     fcc:	00000097          	auipc	ra,0x0
     fd0:	ee0080e7          	jalr	-288(ra) # eac <putc>
     fd4:	a019                	j	fda <vprintf+0x60>
    } else if(state == '%'){
     fd6:	01498d63          	beq	s3,s4,ff0 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
     fda:	0485                	addi	s1,s1,1
     fdc:	fff4c903          	lbu	s2,-1(s1)
     fe0:	14090d63          	beqz	s2,113a <vprintf+0x1c0>
    if(state == 0){
     fe4:	fe0999e3          	bnez	s3,fd6 <vprintf+0x5c>
      if(c == '%'){
     fe8:	ff4910e3          	bne	s2,s4,fc8 <vprintf+0x4e>
        state = '%';
     fec:	89d2                	mv	s3,s4
     fee:	b7f5                	j	fda <vprintf+0x60>
      if(c == 'd'){
     ff0:	11490c63          	beq	s2,s4,1108 <vprintf+0x18e>
     ff4:	f9d9079b          	addiw	a5,s2,-99
     ff8:	0ff7f793          	zext.b	a5,a5
     ffc:	10fc6e63          	bltu	s8,a5,1118 <vprintf+0x19e>
    1000:	f9d9079b          	addiw	a5,s2,-99
    1004:	0ff7f713          	zext.b	a4,a5
    1008:	10ec6863          	bltu	s8,a4,1118 <vprintf+0x19e>
    100c:	00271793          	slli	a5,a4,0x2
    ...
    102a:	ea8080e7          	jalr	-344(ra) # ece <printint>
    102e:	8b4a                	mv	s6,s2
      } else {
    ...
    1046:	e8c080e7          	jalr	-372(ra) # ece <printint>
    104a:	8b4a                	mv	s6,s2
      state = 0;
    104c:	4981                	li	s3,0
    ...
    1062:	e70080e7          	jalr	-400(ra) # ece <printint>
    1066:	8b4a                	mv	s6,s2
      state = 0;
    1068:	4981                	li	s3,0
  ...
  putc(fd, '0');
    ...
    1082:	e2e080e7          	jalr	-466(ra) # eac <putc>
  putc(fd, 'x');
    1086:	07800593          	li	a1,120
    108a:	8556                	mv	a0,s5
    108c:	00000097          	auipc	ra,0x0
    1090:	e20080e7          	jalr	-480(ra) # eac <putc>
    1094:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10a6:	e0a080e7          	jalr	-502(ra) # eac <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10aa:	0992                	slli	s3,s3,0x4
    10ac:	397d                	addiw	s2,s2,-1
    10ae:	fe0914e3          	bnez	s2,1096 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    10b2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10b6:	4981                	li	s3,0
    10b8:	b70d                	j	fda <vprintf+0x60>
        s = va_arg(ap, char*);
    10ba:	008b0913          	addi	s2,s6,8
    10be:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    10c2:	02098163          	beqz	s3,10e4 <vprintf+0x16a>
        while(*s != 0){
    10c6:	0009c583          	lbu	a1,0(s3)
    10ca:	c5ad                	beqz	a1,1134 <vprintf+0x1ba>
          putc(fd, *s);
    10cc:	8556                	mv	a0,s5
    10ce:	00000097          	auipc	ra,0x0
    10d2:	dde080e7          	jalr	-546(ra) # eac <putc>
          s++;
    10d6:	0985                	addi	s3,s3,1
        while(*s != 0){
    10d8:	0009c583          	lbu	a1,0(s3)
    10dc:	f9e5                	bnez	a1,10cc <vprintf+0x152>
        s = va_arg(ap, char*);
    10de:	8b4a                	mv	s6,s2
      state = 0;
    10e0:	4981                	li	s3,0
    10e2:	bde5                	j	fda <vprintf+0x60>
          s = "(null)";
    10e4:	00000997          	auipc	s3,0x0
    10e8:	38c98993          	addi	s3,s3,908 # 1470 <malloc+0x232>
        while(*s != 0){
    10ec:	85ee                	mv	a1,s11
    10ee:	bff9                	j	10cc <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    10f0:	008b0913          	addi	s2,s6,8
    10f4:	000b4583          	lbu	a1,0(s6)
    10f8:	8556                	mv	a0,s5
    10fa:	00000097          	auipc	ra,0x0
    10fe:	db2080e7          	jalr	-590(ra) # eac <putc>
    1102:	8b4a                	mv	s6,s2
      state = 0;
    1104:	4981                	li	s3,0
    1106:	bdd1                	j	fda <vprintf+0x60>
        putc(fd, c);
    1108:	85d2                	mv	a1,s4
    110a:	8556                	mv	a0,s5
    110c:	00000097          	auipc	ra,0x0
    1110:	da0080e7          	jalr	-608(ra) # eac <putc>
      state = 0;
    1114:	4981                	li	s3,0
    1116:	b5d1                	j	fda <vprintf+0x60>
        putc(fd, '%');
    1118:	85d2                	mv	a1,s4
    111a:	8556                	mv	a0,s5
    111c:	00000097          	auipc	ra,0x0
    1120:	d90080e7          	jalr	-624(ra) # eac <putc>
        putc(fd, c);
    1124:	85ca                	mv	a1,s2
    1126:	8556                	mv	a0,s5
    1128:	00000097          	auipc	ra,0x0
    112c:	d84080e7          	jalr	-636(ra) # eac <putc>
      state = 0;
    1130:	4981                	li	s3,0
    ...
    11f2:	00e6ea63          	bltu	a3,a4,1206 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    120c:	02059813          	slli	a6,a1,0x20
    1210:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1220:	02061593          	slli	a1,a2,0x20
    1224:	01c5d713          	srli	a4,a1,0x1c
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1252:	02051493          	slli	s1,a0,0x20
    1256:	9081                	srli	s1,s1,0x20
    1258:	04bd                	addi	s1,s1,15
    125a:	8091                	srli	s1,s1,0x4
    125c:	0014899b          	addiw	s3,s1,1
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    128e:	d8690913          	addi	s2,s2,-634 # 2010 <freep>
  if(p == (char*)-1)
    1292:	5afd                	li	s5,-1
    1294:	a895                	j	1308 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    1296:	00001797          	auipc	a5,0x1
    129a:	df278793          	addi	a5,a5,-526 # 2088 <base>
    ...
    12b6:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12b8:	02071693          	slli	a3,a4,0x20
    12bc:	01c6d713          	srli	a4,a3,0x1c
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1318:	b58080e7          	jalr	-1192(ra) # e6c <sbrk>
  if(p == (char*)-1)
